...
class TestPakistan(TestCase):
    ...
    def test_kashmir_day(self):
        ...
        self.assertHolidaysName(name, (f"{year}-02-05" for year in range(1990, 2050)))
        self.assertNoHolidayName(name, range(1948, 1990))

    def test_pakistan_day(self):
        name = "Pakistan Day"
        self.assertHolidaysName(name, (f"{year}-03-23" for year in range(1956, 2050)))
        self.assertNoHolidayName(name, range(1948, 1956))

    def test_labour_day(self):
        name = "Labour Day"
        self.assertHolidaysName(name, (f"{year}-05-01" for year in range(1972, 2050)))
    ...
    def test_iqbal_day(self):
        name = "Iqbal Day"
        self.assertHolidaysName(name, (f"{year}-11-09" for year in range(1948, 2015)))
        self.assertHolidaysName(name, (f"{year}-11-09" for year in range(2022, 2050)))
