...
class TestChina(CommonCountryTests, TestCase):
    ...
    def test_substituted_holidays(self):
        h = China(years=2001)
        self.assertTrue(h.is_working_day("2001-01-20"))
        self.assertTrue(h.is_working_day("2001-01-21"))
        self.assertTrue(h.is_working_day("2001-04-28"))
        self.assertTrue(h.is_working_day("2001-04-29"))
        self.assertTrue(h.is_working_day("2001-09-29"))
        self.assertTrue(h.is_working_day("2001-09-30"))
        self.assertTrue(h.is_working_day("2001-12-29"))
        self.assertTrue(h.is_working_day("2001-12-30"))
        h = China(years=2005)
        self.assertTrue(h.is_working_day("2005-02-05"))
        self.assertTrue(h.is_working_day("2005-02-06"))
        self.assertTrue(h.is_working_day("2005-04-30"))
        self.assertTrue(h.is_working_day("2005-05-08"))
        self.assertTrue(h.is_working_day("2005-10-08"))
        self.assertTrue(h.is_working_day("2005-10-09"))
        self.assertTrue(h.is_working_day("2005-12-31"))
        h = China(years=2006)
        self.assertTrue(h.is_working_day("2006-01-28"))
        self.assertTrue(h.is_working_day("2006-02-05"))
        self.assertTrue(h.is_working_day("2006-04-29"))
        self.assertTrue(h.is_working_day("2006-04-30"))
        self.assertTrue(h.is_working_day("2006-09-30"))
        self.assertTrue(h.is_working_day("2006-10-08"))
        self.assertTrue(h.is_working_day("2006-12-30"))
        self.assertTrue(h.is_working_day("2006-12-31"))
        h = China(years=2011)
        self.assertTrue(h.is_working_day("2011-01-30"))
        self.assertTrue(h.is_working_day("2011-02-12"))
        self.assertTrue(h.is_working_day("2011-04-02"))
        self.assertTrue(h.is_working_day("2011-10-08"))
        self.assertTrue(h.is_working_day("2011-10-09"))
        self.assertTrue(h.is_working_day("2011-12-31"))
