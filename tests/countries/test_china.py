...
class TestChina(TestCase):
    ...
    def test_l10n_th(self):
        self.assertLocalizedHolidays(
            ...
            ("2022-01-31", "วันพัก (แทนที่จาก 29/01/2022)"),
            ("2022-02-01", "วันตรุษจีน"),
            ("2022-02-02", "วันตรุษจีน"),
            ("2022-02-03", "วันตรุษจีน"),
            ("2022-02-04", "วันพัก (แทนที่จาก 30/01/2022)"),
            ("2022-03-08", "วันสตรีสากล"),
            ("2022-04-04", "วันพัก (แทนที่จาก 02/04/2022)"),
            ("2022-04-05", "วันเช็งเม้ง"),
            ("2022-05-01", "วันแรงงาน"),
            ("2022-05-02", "ชดเชยวันแรงงาน"),
            ("2022-05-03", "วันพัก (แทนที่จาก 24/04/2022)"),
            ("2022-05-04", "วันพัก (แทนที่จาก 07/05/2022); วันเยาวชนห่งชาติจีน"),
            ...
            ("2022-10-06", "วันพัก (แทนที่จาก 08/10/2022)"),
            ("2022-10-07", "วันพัก (แทนที่จาก 09/10/2022)"),
        )
