...
class TestChina(CommonCountryTests, WorkingDayTests, TestCase):
    ...
    def test_new_years_day(self):
        ...
        self.assertHolidayName(f"{name}（补假）", obs_dts)
    ...
    def test_2001_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2001-01-25", "春节"),
            ("2001-01-26", "春节"),
            ("2001-01-29", "休息日（由 2001-01-20 调休）"),
            ("2001-01-30", "休息日（由 2001-01-21 调休）"),
            ("2001-05-01", "劳动节"),
            ("2001-05-02", "劳动节"),
            ("2001-05-03", "劳动节"),
            ("2001-05-04", "休息日（由 2001-04-28 调休）"),
            ("2001-05-07", "休息日（由 2001-04-29 调休）"),
            ("2001-10-01", "国庆节"),
            ("2001-10-02", "国庆节"),
            ("2001-10-03", "国庆节"),
            ("2001-10-04", "休息日（由 2001-09-29 调休）"),
            ("2001-10-05", "休息日（由 2001-09-30 调休）"),
        )
    ...
    def test_2002_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2002,
            ("2002-01-01", "元旦"),
            ("2002-01-02", "休息日（由 2001-12-29 调休）"),
            ("2002-01-03", "休息日（由 2001-12-30 调休）"),
            ("2002-02-12", "春节"),
            ("2002-02-13", "春节"),
            ("2002-02-14", "春节"),
            ("2002-02-15", "休息日（由 2002-02-09 调休）"),
            ("2002-02-18", "休息日（由 2002-02-10 调休）"),
            ("2002-05-01", "劳动节"),
            ("2002-05-02", "劳动节"),
            ("2002-05-03", "劳动节"),
            ("2002-05-06", "休息日（由 2002-04-27 调休）"),
            ("2002-05-07", "休息日（由 2002-04-28 调休）"),
            ("2002-10-01", "国庆节"),
            ("2002-10-02", "国庆节"),
            ("2002-10-03", "国庆节"),
            ("2002-10-04", "休息日（由 2002-09-28 调休）"),
            ("2002-10-07", "休息日（由 2002-09-29 调休）"),
        )
    ...
    def test_2003_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2003-02-04", "春节（补假）"),
            ("2003-02-05", "春节（补假）"),
            ("2003-02-06", "休息日（由 2003-02-08 调休）"),
            ("2003-02-07", "休息日（由 2003-02-09 调休）"),
            ("2003-05-01", "劳动节"),
            ("2003-05-02", "劳动节"),
            ("2003-05-03", "劳动节"),
            ("2003-05-05", "劳动节（补假）"),
            ("2003-05-06", "休息日（由 2003-04-26 调休）"),
            ("2003-05-07", "休息日（由 2003-04-27 调休）"),
            ("2003-10-01", "国庆节"),
            ("2003-10-02", "国庆节"),
            ("2003-10-03", "国庆节"),
            ("2003-10-06", "休息日（由 2003-09-27 调休）"),
            ("2003-10-07", "休息日（由 2003-09-28 调休）"),
        )
    ...
    def test_2004_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2004-01-24", "春节"),
            ("2004-01-26", "春节（补假）"),
            ("2004-01-27", "休息日（由 2004-01-17 调休）"),
            ("2004-01-28", "休息日（由 2004-01-18 调休）"),
            ("2004-05-01", "劳动节"),
            ("2004-05-02", "劳动节"),
            ("2004-05-03", "劳动节"),
            ("2004-05-04", "劳动节（补假）"),
            ("2004-05-05", "劳动节（补假）"),
            ("2004-05-06", "休息日（由 2004-05-08 调休）"),
            ("2004-05-07", "休息日（由 2004-05-09 调休）"),
            ("2004-10-01", "国庆节"),
            ("2004-10-02", "国庆节"),
            ("2004-10-03", "国庆节"),
            ("2004-10-04", "国庆节（补假）"),
            ("2004-10-05", "国庆节（补假）"),
            ("2004-10-06", "休息日（由 2004-10-09 调休）"),
            ("2004-10-07", "休息日（由 2004-10-10 调休）"),
        )
    ...
    def test_2005_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2005-02-10", "春节"),
            ("2005-02-11", "春节"),
            ("2005-02-14", "休息日（由 2005-02-05 调休）"),
            ("2005-02-15", "休息日（由 2005-02-06 调休）"),
            ("2005-05-01", "劳动节"),
            ("2005-05-02", "劳动节"),
            ("2005-05-03", "劳动节"),
            ("2005-05-04", "劳动节（补假）"),
            ("2005-05-05", "休息日（由 2005-04-30 调休）"),
            ("2005-05-06", "休息日（由 2005-05-08 调休）"),
            ("2005-10-01", "国庆节"),
            ("2005-10-02", "国庆节"),
            ("2005-10-03", "国庆节"),
            ("2005-10-04", "国庆节（补假）"),
            ("2005-10-05", "国庆节（补假）"),
            ("2005-10-06", "休息日（由 2005-10-08 调休）"),
            ("2005-10-07", "休息日（由 2005-10-09 调休）"),
        )
    ...
    def test_2006_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2006-01-01", "元旦"),
            ("2006-01-02", "元旦（补假）"),
            ("2006-01-03", "休息日（由 2005-12-31 调休）"),
            ("2006-01-29", "春节"),
            ("2006-01-30", "春节"),
            ("2006-01-31", "春节"),
            ("2006-02-01", "春节（补假）"),
            ("2006-02-02", "休息日（由 2006-01-28 调休）"),
            ("2006-02-03", "休息日（由 2006-02-05 调休）"),
            ("2006-05-01", "劳动节"),
            ("2006-05-02", "劳动节"),
            ("2006-05-03", "劳动节"),
            ("2006-05-04", "休息日（由 2006-04-29 调休）"),
            ("2006-05-05", "休息日（由 2006-04-30 调休）"),
            ("2006-10-01", "国庆节"),
            ("2006-10-02", "国庆节"),
            ("2006-10-03", "国庆节"),
            ("2006-10-04", "国庆节（补假）"),
            ("2006-10-05", "休息日（由 2006-09-30 调休）"),
            ("2006-10-06", "休息日（由 2006-10-08 调休）"),
        )
    ...
    def test_2007_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2007,
            ("2007-01-01", "元旦"),
            ("2007-01-02", "休息日（由 2006-12-30 调休）"),
            ("2007-01-03", "休息日（由 2006-12-31 调休）"),
            ("2007-02-18", "春节"),
            ("2007-02-19", "春节"),
            ("2007-02-20", "春节"),
            ("2007-02-21", "春节（补假）"),
            ("2007-02-22", "休息日（由 2007-02-17 调休）"),
            ("2007-02-23", "休息日（由 2007-02-25 调休）"),
            ("2007-05-01", "劳动节"),
            ("2007-05-02", "劳动节"),
            ("2007-05-03", "劳动节"),
            ("2007-05-04", "休息日（由 2007-04-28 调休）"),
            ("2007-05-07", "休息日（由 2007-04-29 调休）"),
            ("2007-10-01", "国庆节"),
            ("2007-10-02", "国庆节"),
            ("2007-10-03", "国庆节"),
            ("2007-10-04", "休息日（由 2007-09-29 调休）"),
            ("2007-10-05", "休息日（由 2007-09-30 调休）"),
            ("2007-12-31", "休息日（由 2007-12-29 调休）"),
        )
    ...
    def test_2008_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2008-02-07", "春节"),
            ("2008-02-08", "春节"),
            ("2008-02-11", "休息日（由 2008-02-02 调休）"),
            ("2008-02-12", "休息日（由 2008-02-03 调休）"),
            ("2008-04-04", "清明节"),
            ("2008-05-01", "劳动节"),
            ("2008-05-02", "休息日（由 2008-05-04 调休）"),
            ("2008-06-08", "端午节"),
            ("2008-06-09", "端午节（补假）"),
            ("2008-09-14", "中秋节"),
            ("2008-09-15", "中秋节（补假）"),
            ("2008-09-29", "休息日（由 2008-09-27 调休）"),
            ("2008-09-30", "休息日（由 2008-09-28 调休）"),
            ("2008-10-01", "国庆节"),
            ("2008-10-02", "国庆节"),
            ("2008-10-03", "国庆节"),
        )
    ...
    def test_2009_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2009,
            ("2009-01-01", "元旦"),
            ("2009-01-02", "休息日（由 2009-01-04 调休）"),
            ("2009-01-25", "农历除夕"),
            ("2009-01-26", "春节"),
            ("2009-01-27", "春节"),
            ("2009-01-28", "农历除夕（补假）"),
            ("2009-01-29", "休息日（由 2009-01-24 调休）"),
            ("2009-01-30", "休息日（由 2009-02-01 调休）"),
            ("2009-04-04", "清明节"),
            ("2009-04-06", "清明节（补假）"),
            ("2009-05-01", "劳动节"),
            ("2009-05-28", "端午节"),
            ("2009-05-29", "休息日（由 2009-05-31 调休）"),
            ("2009-10-01", "国庆节"),
            ("2009-10-02", "国庆节"),
            ("2009-10-03", "中秋节; 国庆节"),
            ("2009-10-05", "中秋节（补假）"),
            ("2009-10-06", "国庆节（补假）"),
            ("2009-10-07", "休息日（由 2009-09-27 调休）"),
            ("2009-10-08", "休息日（由 2009-10-10 调休）"),
        )
    ...
    def test_2010_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2010-02-16", "农历除夕（补假）"),
            ("2010-02-17", "春节（补假）"),
            ("2010-02-18", "休息日（由 2010-02-20 调休）"),
            ("2010-02-19", "休息日（由 2010-02-21 调休）"),
            ("2010-04-05", "清明节"),
            ("2010-05-01", "劳动节"),
            ("2010-05-03", "劳动节（补假）"),
            ("2010-06-14", "休息日（由 2010-06-12 调休）"),
            ("2010-06-15", "休息日（由 2010-06-13 调休）"),
            ("2010-06-16", "端午节"),
            ("2010-09-22", "中秋节"),
            ("2010-09-23", "休息日（由 2010-09-19 调休）"),
            ("2010-09-24", "休息日（由 2010-09-25 调休）"),
            ("2010-10-01", "国庆节"),
            ("2010-10-02", "国庆节"),
            ("2010-10-03", "国庆节"),
            ("2010-10-04", "国庆节（补假）"),
            ("2010-10-05", "国庆节（补假）"),
            ("2010-10-06", "休息日（由 2010-09-26 调休）"),
            ("2010-10-07", "休息日（由 2010-10-09 调休）"),
        )
    ...
    def test_2011_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2011-02-03", "春节"),
            ("2011-02-04", "春节"),
            ("2011-02-07", "休息日（由 2011-01-30 调休）"),
            ("2011-02-08", "休息日（由 2011-02-12 调休）"),
            ("2011-04-04", "休息日（由 2011-04-02 调休）"),
            ("2011-04-05", "清明节"),
            ("2011-05-01", "劳动节"),
            ("2011-05-02", "劳动节（补假）"),
            ("2011-06-06", "端午节"),
            ...
            ("2011-10-04", "国庆节（补假）"),
            ("2011-10-05", "国庆节（补假）"),
            ("2011-10-06", "休息日（由 2011-10-08 调休）"),
            ("2011-10-07", "休息日（由 2011-10-09 调休）"),
        )
    ...
    def test_2012_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2012-01-01", "元旦"),
            ("2012-01-02", "元旦（补假）"),
            ("2012-01-03", "休息日（由 2011-12-31 调休）"),
            ("2012-01-22", "农历除夕"),
            ("2012-01-23", "春节"),
            ("2012-01-24", "春节"),
            ("2012-01-25", "农历除夕（补假）"),
            ("2012-01-26", "休息日（由 2012-01-21 调休）"),
            ("2012-01-27", "休息日（由 2012-01-29 调休）"),
            ("2012-04-02", "休息日（由 2012-03-31 调休）"),
            ("2012-04-03", "休息日（由 2012-04-01 调休）"),
            ("2012-04-04", "清明节"),
            ("2012-04-30", "休息日（由 2012-04-28 调休）"),
            ("2012-05-01", "劳动节"),
            ("2012-06-22", "端午节（补假）"),
            ("2012-06-23", "端午节"),
            ("2012-09-30", "中秋节"),
            ...
            ("2012-10-03", "国庆节"),
            ("2012-10-04", "中秋节（补假）"),
            ("2012-10-05", "休息日（由 2012-09-29 调休）"),
        )
    ...
    def test_2013_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2013,
            ("2013-01-01", "元旦"),
            ("2013-01-02", "休息日（由 2013-01-05 调休）"),
            ("2013-01-03", "休息日（由 2013-01-06 调休）"),
            ("2013-02-09", "农历除夕"),
            ("2013-02-10", "春节"),
            ("2013-02-11", "春节"),
            ("2013-02-12", "农历除夕（补假）"),
            ("2013-02-13", "春节（补假）"),
            ("2013-02-14", "休息日（由 2013-02-16 调休）"),
            ("2013-02-15", "休息日（由 2013-02-17 调休）"),
            ("2013-04-04", "清明节"),
            ("2013-04-05", "休息日（由 2013-04-07 调休）"),
            ("2013-04-29", "休息日（由 2013-04-27 调休）"),
            ("2013-04-30", "休息日（由 2013-04-28 调休）"),
            ("2013-05-01", "劳动节"),
            ("2013-06-10", "休息日（由 2013-06-08 调休）"),
            ("2013-06-11", "休息日（由 2013-06-09 调休）"),
            ("2013-06-12", "端午节"),
            ("2013-09-19", "中秋节"),
            ("2013-09-20", "休息日（由 2013-09-22 调休）"),
            ("2013-10-01", "国庆节"),
            ("2013-10-02", "国庆节"),
            ("2013-10-03", "国庆节"),
            ("2013-10-04", "休息日（由 2013-09-29 调休）"),
            ("2013-10-07", "休息日（由 2013-10-12 调休）"),
        )
    ...
    def test_2014_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2014-02-03", "春节（补假）"),
            ("2014-02-04", "春节（补假）"),
            ("2014-02-05", "休息日（由 2014-01-26 调休）"),
            ("2014-02-06", "休息日（由 2014-02-08 调休）"),
            ("2014-04-05", "清明节"),
            ("2014-04-07", "清明节（补假）"),
            ("2014-05-01", "劳动节"),
            ("2014-05-02", "休息日（由 2014-05-04 调休）"),
            ("2014-06-02", "端午节"),
            ("2014-09-08", "中秋节"),
            ("2014-10-01", "国庆节"),
            ("2014-10-02", "国庆节"),
            ("2014-10-03", "国庆节"),
            ("2014-10-06", "休息日（由 2014-09-28 调休）"),
            ("2014-10-07", "休息日（由 2014-10-11 调休）"),
        )
    ...
    def test_2015_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2015,
            ("2015-01-01", "元旦"),
            ("2015-01-02", "休息日（由 2015-01-04 调休）"),
            ("2015-02-18", "休息日（由 2015-02-15 调休）"),
            ("2015-02-19", "春节"),
            ("2015-02-20", "春节"),
            ("2015-02-21", "春节"),
            ("2015-02-23", "春节（补假）"),
            ("2015-02-24", "休息日（由 2015-02-28 调休）"),
            ("2015-04-05", "清明节"),
            ("2015-04-06", "清明节（补假）"),
            ("2015-05-01", "劳动节"),
            ("2015-06-20", "端午节"),
            ...
            ("2015-09-04", "休息日（由 2015-09-06 调休）"),
            ("2015-09-27", "中秋节"),
            ("2015-10-01", "国庆节"),
            ("2015-10-02", "国庆节"),
            ("2015-10-03", "国庆节"),
            ("2015-10-05", "国庆节（补假）"),
            ("2015-10-06", "中秋节（补假）"),
            ("2015-10-07", "休息日（由 2015-10-10 调休）"),
        )
    ...
    def test_2016_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2016-02-09", "春节"),
            ("2016-02-10", "春节"),
            ("2016-02-11", "休息日（由 2016-02-06 调休）"),
            ("2016-02-12", "休息日（由 2016-02-14 调休）"),
            ("2016-04-04", "清明节"),
            ("2016-05-01", "劳动节"),
            ("2016-05-02", "劳动节（补假）"),
            ("2016-06-09", "端午节"),
            ("2016-06-10", "休息日（由 2016-06-12 调休）"),
            ("2016-09-15", "中秋节"),
            ("2016-09-16", "休息日（由 2016-09-18 调休）"),
            ("2016-10-01", "国庆节"),
            ("2016-10-02", "国庆节"),
            ("2016-10-03", "国庆节"),
            ("2016-10-04", "国庆节（补假）"),
            ("2016-10-05", "国庆节（补假）"),
            ("2016-10-06", "休息日（由 2016-10-08 调休）"),
            ("2016-10-07", "休息日（由 2016-10-09 调休）"),
        )
    ...
    def test_2017_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2017-01-01", "元旦"),
            ("2017-01-02", "元旦（补假）"),
            ("2017-01-27", "休息日（由 2017-01-22 调休）"),
            ("2017-01-28", "春节"),
            ("2017-01-29", "春节"),
            ("2017-01-30", "春节"),
            ("2017-01-31", "春节（补假）"),
            ("2017-02-01", "春节（补假）"),
            ("2017-02-02", "休息日（由 2017-02-04 调休）"),
            ("2017-04-03", "休息日（由 2017-04-01 调休）"),
            ("2017-04-04", "清明节"),
            ("2017-05-01", "劳动节"),
            ("2017-05-29", "休息日（由 2017-05-27 调休）"),
            ("2017-05-30", "端午节"),
            ("2017-10-01", "国庆节"),
            ("2017-10-02", "国庆节"),
            ("2017-10-03", "国庆节"),
            ("2017-10-04", "中秋节"),
            ("2017-10-05", "国庆节（补假）"),
            ("2017-10-06", "休息日（由 2017-09-30 调休）"),
        )
    ...
    def test_2018_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2018,
            ("2018-01-01", "元旦"),
            ("2018-02-15", "休息日（由 2018-02-11 调休）"),
            ("2018-02-16", "春节"),
            ("2018-02-17", "春节"),
            ("2018-02-18", "春节"),
            ("2018-02-19", "春节（补假）"),
            ("2018-02-20", "春节（补假）"),
            ("2018-02-21", "休息日（由 2018-02-24 调休）"),
            ("2018-04-05", "清明节"),
            ("2018-04-06", "休息日（由 2018-04-08 调休）"),
            ...
            ("2018-10-02", "国庆节"),
            ("2018-10-03", "国庆节"),
            ("2018-10-04", "休息日（由 2018-09-29 调休）"),
            ("2018-10-05", "休息日（由 2018-09-30 调休）"),
    ...
    def test_2019_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2019,
            ("2019-01-01", "元旦"),
            ("2019-02-04", "休息日（由 2019-02-02 调休）"),
            ("2019-02-05", "春节"),
            ("2019-02-06", "春节"),
            ("2019-02-07", "春节"),
            ("2019-02-08", "休息日（由 2019-02-03 调休）"),
            ("2019-04-05", "清明节"),
            ("2019-05-01", "劳动节"),
            ("2019-05-02", "休息日（由 2019-04-28 调休）"),
            ("2019-05-03", "休息日（由 2019-05-05 调休）"),
            ("2019-06-07", "端午节"),
            ("2019-09-13", "中秋节"),
            ("2019-10-01", "国庆节"),
            ("2019-10-02", "国庆节"),
            ("2019-10-03", "国庆节"),
            ("2019-10-04", "休息日（由 2019-09-29 调休）"),
            ("2019-10-07", "休息日（由 2019-10-12 调休）"),
        )
    ...
    def test_2020_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2020,
            ("2020-01-01", "元旦"),
            ("2020-01-24", "休息日（由 2020-01-19 调休）"),
            ("2020-01-25", "春节"),
            ("2020-01-26", "春节"),
            ("2020-01-27", "春节"),
            ("2020-01-28", "春节（补假）"),
            ...
            ("2020-04-06", "清明节（补假）"),
            ("2020-05-01", "劳动节"),
            ("2020-05-04", "休息日（由 2020-04-26 调休）"),
            ("2020-05-05", "休息日（由 2020-05-09 调休）"),
            ("2020-06-25", "端午节"),
            ("2020-06-26", "休息日（由 2020-06-28 调休）"),
            ("2020-10-01", "中秋节; 国庆节"),
            ("2020-10-02", "国庆节"),
            ("2020-10-03", "国庆节"),
            ("2020-10-05", "国庆节（补假）"),
            ("2020-10-06", "中秋节（补假）"),
            ("2020-10-07", "休息日（由 2020-09-27 调休）"),
            ("2020-10-08", "休息日（由 2020-10-10 调休）"),
        )
    ...
    def test_2021_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2021,
            ("2021-01-01", "元旦"),
            ("2021-02-11", "休息日（由 2021-02-07 调休）"),
            ("2021-02-12", "春节"),
            ("2021-02-13", "春节"),
            ("2021-02-14", "春节"),
            ("2021-02-15", "春节（补假）"),
            ("2021-02-16", "春节（补假）"),
            ("2021-02-17", "休息日（由 2021-02-20 调休）"),
            ("2021-04-04", "清明节"),
            ("2021-04-05", "清明节（补假）"),
            ("2021-05-01", "劳动节"),
            ("2021-05-03", "劳动节（补假）"),
            ("2021-05-04", "休息日（由 2021-04-25 调休）"),
            ("2021-05-05", "休息日（由 2021-05-08 调休）"),
            ("2021-06-14", "端午节"),
            ("2021-09-20", "休息日（由 2021-09-18 调休）"),
            ("2021-09-21", "中秋节"),
            ("2021-10-01", "国庆节"),
            ("2021-10-02", "国庆节"),
            ("2021-10-03", "国庆节"),
            ("2021-10-04", "国庆节（补假）"),
            ("2021-10-05", "国庆节（补假）"),
            ("2021-10-06", "休息日（由 2021-09-26 调休）"),
            ("2021-10-07", "休息日（由 2021-10-09 调休）"),
        )
    ...
    def test_2022_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2022-01-01", "元旦"),
            ("2022-01-03", "元旦（补假）"),
            ("2022-01-31", "休息日（由 2022-01-29 调休）"),
            ("2022-02-01", "春节"),
            ("2022-02-02", "春节"),
            ("2022-02-03", "春节"),
            ("2022-02-04", "休息日（由 2022-01-30 调休）"),
            ("2022-04-04", "休息日（由 2022-04-02 调休）"),
            ("2022-04-05", "清明节"),
            ("2022-05-01", "劳动节"),
            ("2022-05-02", "劳动节（补假）"),
            ("2022-05-03", "休息日（由 2022-04-24 调休）"),
            ("2022-05-04", "休息日（由 2022-05-07 调休）"),
            ("2022-06-03", "端午节"),
            ("2022-09-10", "中秋节"),
            ("2022-09-12", "中秋节（补假）"),
            ("2022-10-01", "国庆节"),
            ...
            ("2022-10-04", "国庆节（补假）"),
            ("2022-10-05", "国庆节（补假）"),
            ("2022-10-06", "休息日（由 2022-10-08 调休）"),
            ("2022-10-07", "休息日（由 2022-10-09 调休）"),
        )
    ...
    def test_2023_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2023-01-24", "春节"),
            ("2023-01-25", "春节（补假）"),
            ("2023-01-26", "休息日（由 2023-01-28 调休）"),
            ("2023-01-27", "休息日（由 2023-01-29 调休）"),
            ("2023-04-05", "清明节"),
            ("2023-05-01", "劳动节"),
            ("2023-05-02", "休息日（由 2023-04-23 调休）"),
            ("2023-05-03", "休息日（由 2023-05-06 调休）"),
            ("2023-06-22", "端午节"),
            ("2023-06-23", "休息日（由 2023-06-25 调休）"),
            ("2023-09-29", "中秋节"),
            ("2023-10-01", "国庆节"),
            ("2023-10-02", "国庆节"),
            ("2023-10-03", "国庆节"),
            ("2023-10-04", "国庆节（补假）"),
            ("2023-10-05", "休息日（由 2023-10-07 调休）"),
            ("2023-10-06", "休息日（由 2023-10-08 调休）"),
        )
    ...
    def test_2025_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            ...
            ("2025-01-30", "春节"),
            ("2025-01-31", "春节"),
            ("2025-02-03", "休息日（由 2025-01-26 调休）"),
            ("2025-02-04", "休息日（由 2025-02-08 调休）"),
            ("2025-04-04", "清明节"),
            ("2025-05-01", "劳动节"),
            ("2025-05-02", "劳动节"),
            ("2025-05-05", "休息日（由 2025-04-27 调休）"),
            ("2025-05-31", "端午节"),
            ("2025-06-02", "端午节（补假）"),
            ("2025-10-01", "国庆节"),
            ("2025-10-02", "国庆节"),
            ("2025-10-03", "国庆节"),
            ("2025-10-06", "中秋节"),
            ("2025-10-07", "休息日（由 2025-09-28 调休）"),
            ("2025-10-08", "休息日（由 2025-10-11 调休）"),
        )
    ...
    def test_2026_public_holiday(self):
        ...
        self.assertHolidaysInYear(
            2026,
            ("2026-01-01", "元旦"),
            ("2026-01-02", "休息日（由 2026-01-04 调休）"),
            ("2026-02-16", "农历除夕"),
            ("2026-02-17", "春节"),
            ("2026-02-18", "春节"),
            ("2026-02-19", "春节"),
            ("2026-02-20", "休息日（由 2026-02-14 调休）"),
            ("2026-02-23", "休息日（由 2026-02-28 调休）"),
            ("2026-04-05", "清明节"),
            ("2026-04-06", "清明节（补假）"),
            ("2026-05-01", "劳动节"),
            ("2026-05-02", "劳动节"),
            ("2026-05-04", "劳动节（补假）"),
            ("2026-05-05", "休息日（由 2026-05-09 调休）"),
            ("2026-06-19", "端午节"),
            ("2026-09-25", "中秋节"),
            ("2026-10-01", "国庆节"),
            ("2026-10-02", "国庆节"),
            ("2026-10-03", "国庆节"),
            ("2026-10-05", "国庆节（补假）"),
            ("2026-10-06", "休息日（由 2026-09-20 调休）"),
            ("2026-10-07", "休息日（由 2026-10-10 调休）"),
        )
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2022-05-02", "劳动节（补假）"),
            ("2022-05-03", "休息日（由 2022-04-24 调休）"),
            ("2022-05-04", "五四青年节; 休息日（由 2022-05-07 调休）"),
            ("2022-06-01", "六一儿童节"),
            ("2022-06-03", "端午节"),
            ("2022-08-01", "建军节"),
            ("2022-09-10", "中秋节"),
