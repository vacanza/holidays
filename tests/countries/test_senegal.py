...
class TestSenegal(CommonCountryTests, TestCase):
    ...
    def test_no_holidays(self):
        self.assertNoHolidays(Senegal(years=1959))
    ...
    def test_independence_day(self):
        ...
        self.assertHolidayName(name, (f"{year}-04-04" for year in range(1960, 2050)))
    ...
    def test_assumption_of_mary_day(self):
        name = "Assomption"
        self.assertHolidayName(name, (f"{year}-08-15" for year in range(1960, 2050)))

    def test_all_saints_day(self):
        name = "Toussaint"
        self.assertHolidayName(name, (f"{year}-11-01" for year in range(1960, 2050)))
