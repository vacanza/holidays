...
class TestNZ(unittest.TestCase):
    def setUp(self):
        self.holidays = country_holidays("NZ", observed=True)
    ...
    def test_waitangi_day(self):
        ntl_holidays = country_holidays("NZ", subdiv="Northland")
    ...
    def test_auckland_anniversary_day(self):
        auk_holidays = country_holidays("NZ", subdiv="Auckland")
        for year, day in enumerate(
            [
                29,
                28,
    ...
    def test_taranaki_anniversary_day(self):
        tki_holidays = country_holidays("NZ", subdiv="Taranaki")
        for year, day in enumerate(
            [
                12,
                11,
    ...
    def test_hawkes_bay_anniversary_day(self):
        hkb_holidays = country_holidays("NZ", subdiv="Hawke's Bay")
        for year, day in enumerate(
            [
                19,
                25,
    ...
    def test_wellington_anniversary_day(self):
        wgn_holidays = country_holidays("NZ", subdiv="Wellington")
        for year, day in enumerate(
            [
                22,
                21,
    ...
    def test_marlborough_anniversary_day(self):
        mbh_holidays = country_holidays("NZ", subdiv="Marlborough")
        for year, day in enumerate(
            [
                29,
                4,
    ...
    def test_nelson_anniversary_day(self):
        nsn_holidays = country_holidays("NZ", subdiv="Nelson")
        for year, day in enumerate(
            [
                29,
                4,
    ...
    def test_canterbury_anniversary_day(self):
        can_holidays = country_holidays("NZ", subdiv="Canterbury")
        for year, day in enumerate(
            [
                16,
                15,
    ...
    def test_south_canterbury_anniversary_day(self):
        stc_holidays = country_holidays("NZ", subdiv="South Canterbury")
        for year, day in enumerate(
            [
                24,
                23,
    ...
    def test_westland_anniversary_day(self):
        wtc_holidays = country_holidays("NZ", subdiv="Westland")
        for year, day in enumerate(
            [
                3,
                2,
    ...
    def test_otago_anniversary_day(self):
        ota_holidays = country_holidays("NZ", subdiv="Otago")
        for year, day in enumerate(
            [
                26,
                25,
    ...
    def test_southland_anniversary_day(self):
        stl_holidays = country_holidays("NZ", subdiv="Southland")
        for year, day in enumerate(
    ...
    def test_chatham_islands_anniversary_day(self):
        cit_holidays = country_holidays("NZ", subdiv="Chatham Islands")
        for year, day in enumerate(
            [
                3,
                2,
    ...
    def test_all_holidays_present(self):
        nz_1969 = sum(
            country_holidays("NZ", years=[1969], subdiv=region)
            for region in NZ.subdivisions
        )
        holidays_in_1969 = sum((nz_1969.get_list(key) for key in nz_1969), [])
        nz_2015 = sum(
            country_holidays("NZ", years=[2015], subdiv=region)
            for region in NZ.subdivisions
        )
        holidays_in_2015 = sum((nz_2015.get_list(key) for key in nz_2015), [])
        nz_1974 = sum(
            country_holidays("NZ", years=[1974], subdiv=region)
            for region in NZ.subdivisions
        )
