...
from holidays.countries.wallis_and_futuna import WallisAndFutuna, WF, WLF
from tests.common import TestCase


class TestWallisAndFutuna(TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(WallisAndFutuna)

    def test_country_aliases(self):
        self.assertCountryAliases(WallisAndFutuna, WF, WLF)
