...
class TestSweden(CommonCountryTests, SundayHolidays, TestCase):
    ...
    def test_l10n_en_us(self):
        self.assertLocalizedHolidays(
            ...
            ("2025-06-01", "Sunday"),
            ("2025-06-06", "Day before Pentecost Eve (from 2pm); National Day"),
            ("2025-06-07", "Pentecost Eve"),
    ...
    def test_l10n_th(self):
        self.assertLocalizedHolidays(
            ...
            ("2025-04-17", "วันพฤหัสศักดิ์สิทธิ์ (ตั้งแต่ 14:00 น.)"),
            ...
            ("2025-06-06", "วันก่อนวันก่อนวันสมโภชพระจิตเจ้า (ตั้งแต่ 14:00 น.); วันชาติสวีเดน"),
    ...
    def test_l10n_uk(self):
        self.assertLocalizedHolidays(
            ...
            ("2025-06-01", "Неділя"),
            ("2025-06-06", "За два дні до Пʼятидесятниці (з 14:00); Національний день"),
            ("2025-06-07", "Переддень Пʼятидесятниці"),
            ("2025-06-08", "Неділя; Пʼятидесятниця"),
            ("2025-06-15", "Неділя"),
            ("2025-06-19", "За два дні до літнього сонцестояння (з 14:00)"),
            ...
            ("2025-12-28", "Неділя"),
            ("2025-12-30", "За два дні до Нового року (з 14:00)"),
