...
class TestIsrael(TestCase):
    ...
    def test_l10n_yi(self):
        self.assertLocalizedHolidays(
            "yi",
            ("2021-02-25", "תנית אסתר"),
            ("2021-02-26", "פּורים"),
            ("2021-03-28", "פסח"),
            ("2021-03-29", "פּסח יום טוּב"),
            ("2021-03-30", "פּסח יום טוּב"),
            ("2021-03-31", "פּסח יום טוּב"),
            ("2021-04-01", "פּסח יום טוּב"),
            ("2021-04-02", "פּסח יום טוּב"),
            ("2021-04-03", "זיבעטן פּסח"),
            (
                "2021-04-14",
                "(באמערקט) אנדענק טאג פאר די מארטירער פון ישראל'ס סיסטעמען און קרבנות פון שינאה",
            ),
            ("2021-04-15", "(באמערקט) זעלבסטשטענדיגקייט טאג"),
            ("2021-04-30", 'ל"ג בעומר'),
            ("2021-05-10", "טאג ירושלים"),
            ("2021-05-17", "וואָכן"),
            ("2021-07-18", "תשעה באב"),
            ("2021-09-07", "נייע יאר"),
            ("2021-09-08", "נייע יאר"),
            ("2021-09-16", "יום כיפור"),
            ("2021-09-21", "סוכות, סוכות"),
            ("2021-09-22", "דער יום־טובֿ סוכות"),
            ("2021-09-23", "דער יום־טובֿ סוכות"),
            ("2021-09-24", "דער יום־טובֿ סוכות"),
            ("2021-09-25", "דער יום־טובֿ סוכות"),
            ("2021-09-26", "דער יום־טובֿ סוכות"),
            ("2021-09-28", "עצרת שמחת תורה/שמיני"),
            ("2021-11-04", "געבוקט"),
            ("2021-11-29", "חנוכה"),
            ("2021-11-30", "חנוכה"),
            ("2021-12-01", "חנוכה"),
