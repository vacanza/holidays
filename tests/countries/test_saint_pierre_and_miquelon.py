...
from holidays.countries.saint_pierre_and_miquelon import PM, SPM
from tests.common import TestCase


class TestSaintPierreAndMiquelon(TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(SaintPierreAndMiquelon)

    def test_country_aliases(self):
        self.assertCountryAliases(SaintPierreAndMiquelon, PM, SPM)
