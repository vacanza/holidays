...
class TestEgypt(CommonCountryTests, TestCase):
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2019-06-04", "عيد الفطر (مُقدَّر)"),
            ("2019-06-05", "عطلة عيد الفطر (مُقدَّر)"),
            ("2019-06-06", "عطلة عيد الفطر (مُقدَّر)"),
            ("2019-06-30", "عيد ثورة 30 يونيو"),
            ("2019-07-23", "عيد ثورة 23 يوليو"),
            ("2019-08-10", "يوم عرفة (مُقدَّر)"),
            ("2019-08-11", "عيد الأضحى (مُقدَّر)"),
            ("2019-08-12", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2019-08-13", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2019-08-31", "رأس السنة الهجرية (مُقدَّر)"),
            ("2019-10-06", "عيد القوات المسلحة"),
            ("2019-11-09", "عيد المولد النبوي (مُقدَّر)"),
        )
