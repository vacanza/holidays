...
class TestAlgeria(CommonCountryTests, TestCase):
    ...
    def test_l10n_kab(self):
        self.assertLocalizedHolidays(
            "kab",
            ("2022-01-01", "Assegas Amaynut"),
            ("2022-01-12", "Yennayer"),
            ("2022-04-16", "Lɛid n Tfaska n Udayen"),
            ("2022-04-18", "Lḥedd n Tfaska"),
            ("2022-05-01", "Ass Amadlan n Yixeddamen"),
            ...
            ("2022-08-15", "Lɛid n Tmerreyt"),
            ("2022-09-26", "Ixef n Useggas n Udayen"),
            ("2022-10-05", "Was n Ussuru"),
