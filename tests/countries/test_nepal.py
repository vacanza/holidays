...
class TestNepal(CommonCountryTests, TestCase):
    ...
    def test_l10n_kn(self):
        self.assertLocalizedHolidays(
            "kn",
            ("2024-01-11", "ಪೃಥ್ವಿ ಜಯಂತಿ"),
            ("2024-01-15", "ಮಾಘ ಸಂಕ್ರಾಂತಿ"),
            ("2024-01-30", "ಹುತಾತ್ಮರ ದಿನ"),
            ("2024-02-10", "ಸೋನಮ್ ಲ್ಹೋಛಾರ್"),
            ("2024-02-19", "ರಾಷ್ಟ್ರೀಯ ಪ್ರಜಾಪ್ರಭುತ್ವ ದಿನ"),
            ("2024-03-08", "ಅಂತರರಾಷ್ಟ್ರೀಯ ಮಹಿಳಾ ದಿನ; ಮಹಾಶಿವರಾತ್ರಿ"),
            ("2024-03-11", "ಗ್ಯಾಲ್ಪೊ ಲ್ಹೋಸಾರ್"),
            ("2024-03-24", "ಫಾಗು ಹುಣ್ಣಿಮೆ"),
            ("2024-03-25", "ಫಾಗು ಹುಣ್ಣಿಮೆ (ತರಾಯಿ)"),
            ("2024-04-11", "ಈದ್ ಅಲ್-ಫಿತರ್"),
            ("2024-04-13", "ನೇಪಾಳಿ ಹೊಸ ವರ್ಷ"),
            ("2024-04-17", "ರಾಮ ನವಮಿ"),
            ("2024-05-01", "ಅಂತರರಾಷ್ಟ್ರೀಯ ಕಾರ್ಮಿಕ ದಿನ"),
            ("2024-05-23", "ಬುದ್ಧ ಜಯಂತಿ"),
            ("2024-05-28", "ಗಣರಾಜ್ಯ ದಿನ"),
            ("2024-06-17", "ಈದ್ ಅಲ್-ಅಧಾ"),
            ("2024-08-19", "ಜನೈ ಪೂರ್ಣಿಮಾ"),
            ("2024-08-26", "ಶ್ರೀಕೃಷ್ಣ ಜನ್ಮಾಷ್ಟಮಿ"),
            ("2024-09-19", "ಸಂವಿಧಾನ ದಿನ"),
            ("2024-10-03", "ಘಟಸ್ಥಾಪನಾ"),
            ("2024-10-10", "ಫುಲ್ಪಾತಿ"),
            ("2024-10-11", "ಮಹಾ ಅಷ್ಟಮಿ; ಮಹಾ ನವಮಿ"),
            ("2024-10-12", "ವಿಜಯ ದಶಮಿ"),
            ("2024-10-13", "ಏಕಾದಶಿ (ದಸರಾ)"),
            ("2024-10-14", "ದ್ವಾದಶಿ (ದಸರಾ)"),
            ("2024-10-31", "ಲಕ್ಷ್ಮಿ ಪೂಜೆ"),
            ("2024-11-01", "ಗೋ ತಿಹಾರ್"),
            ("2024-11-02", "ಗೋವರ್ಧನ ಪೂಜೆ; ಮ್ಹಾ ಪೂಜೆ"),
            ("2024-11-03", "ಭಾಯಿ ತಿಕಾ"),
            ("2024-11-04", "ತಿಹಾರ್ ರಜೆ"),
            ("2024-11-07", "ಛತ್ ಹಬ್ಬ"),
