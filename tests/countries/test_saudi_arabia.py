...
class TestSaudiArabia(CommonCountryTests, TestCase):
    ...
    def test_l10n_bn(self):
        self.assertLocalizedHolidays(
            "bn",
            ("2023-02-22", "প্রতিষ্ঠা দিবস"),
            ("2023-04-21", "ঈদুল ফিতরের ছুটি"),
            ("2023-04-22", "ঈদুল ফিতরের ছুটি"),
            ("2023-04-23", "ঈদুল ফিতরের ছুটি"),
            ("2023-04-24", "ঈদুল ফিতরের ছুটি"),
            ("2023-04-25", "ঈদুল ফিতরের ছুটি (পালিত)"),
            ("2023-04-26", "ঈদুল ফিতরের ছুটি (পালিত)"),
            ("2023-06-27", "আরাফাত দিবস"),
            ("2023-06-28", "ঈদুল আযহার ছুটি"),
            ("2023-06-29", "ঈদুল আযহার ছুটি"),
            ("2023-06-30", "ঈদুল আযহার ছুটি"),
            ("2023-07-02", "ঈদুল আযহার ছুটি (পালিত)"),
            ("2023-09-23", "জাতীয় দিবস"),
            ("2023-09-24", "জাতীয় দিবস (পালিত)"),
        )
