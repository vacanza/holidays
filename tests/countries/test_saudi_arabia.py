...
class TestSaudiArabia(CommonCountryTests, TestCase):
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2023-04-21", "عطلة عيد الفطر (المقدرة)"),
            ("2023-04-22", "عطلة عيد الفطر (المقدرة)"),
            ("2023-04-23", "عطلة عيد الفطر (المقدرة)"),
            ("2023-04-24", "عطلة عيد الفطر (المقدرة)"),
            ("2023-04-25", "عطلة عيد الفطر (المقدرة ملاحظة)"),
            ("2023-04-26", "عطلة عيد الفطر (المقدرة ملاحظة)"),
            ("2023-06-27", "يوم عرفة (المقدرة)"),
            ("2023-06-28", "عطلة عيد الأضحى (المقدرة)"),
            ("2023-06-29", "عطلة عيد الأضحى (المقدرة)"),
            ("2023-06-30", "عطلة عيد الأضحى (المقدرة)"),
            ("2023-07-02", "عطلة عيد الأضحى (المقدرة ملاحظة)"),
