...
class TestKuwait(CommonCountryTests, TestCase):
    ...
    def test_2022(self):
        self.assertHolidays(
            ...
            ("2022-02-28", "ليلة المعراج (مُقدَّر)"),
            ("2022-05-02", "عيد الفطر (مُقدَّر)"),
            ("2022-05-03", "عطلة عيد الفطر (مُقدَّر)"),
            ("2022-05-04", "عطلة عيد الفطر (مُقدَّر)"),
            ("2022-07-08", "يوم عرفة (مُقدَّر)"),
            ("2022-07-09", "عيد الأضحى (مُقدَّر)"),
            ("2022-07-10", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2022-07-11", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2022-07-30", "رأس السنة الهجرية (مُقدَّر)"),
            ("2022-10-08", "عيد المولد النبوي (مُقدَّر)"),
        )

    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ("2023-01-01", "رأس السنة الميلادية"),
            ("2023-02-18", "ليلة المعراج (مُقدَّر)"),
            ("2023-02-25", "اليوم الوطني"),
            ("2023-02-26", "يوم التحرير"),
            ("2023-04-21", "عيد الفطر (مُقدَّر)"),
            ("2023-04-22", "عطلة عيد الفطر (مُقدَّر)"),
            ("2023-04-23", "عطلة عيد الفطر (مُقدَّر)"),
            ("2023-06-27", "يوم عرفة (مُقدَّر)"),
            ("2023-06-28", "عيد الأضحى (مُقدَّر)"),
            ("2023-06-29", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2023-06-30", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2023-07-19", "رأس السنة الهجرية (مُقدَّر)"),
            ("2023-09-27", "عيد المولد النبوي (مُقدَّر)"),
        )
