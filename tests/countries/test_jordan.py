...
class TestJordan(CommonCountryTests, TestCase):
    ...
    def test_2024(self):
        self.assertHolidays(
            ...
            ("2024-02-08", "ليلة المعراج (مُقدَّر)"),
            ("2024-04-10", "عيد الفطر (مُقدَّر)"),
            ("2024-04-11", "عطلة عيد الفطر (مُقدَّر)"),
            ("2024-04-12", "عطلة عيد الفطر (مُقدَّر)"),
            ("2024-05-01", "عيد العمال"),
            ("2024-05-25", "عيد الإستقلال"),
            ("2024-06-15", "يوم عرفة (مُقدَّر)"),
            ("2024-06-16", "عيد الأضحى (مُقدَّر)"),
            ("2024-06-17", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2024-06-18", "عطلة عيد الأضحى (مُقدَّر)"),
            ("2024-07-07", "رأس السنة الهجرية (مُقدَّر)"),
            ("2024-09-15", "عيد المولد النبوي (مُقدَّر)"),
