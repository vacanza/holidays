...
class TestJordan(CommonCountryTests, TestCase):
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-02-08", "ليلة المعراج (مقدرة)"),
            ("2024-04-10", "عيد الفطر (مقدرة)"),
            ("2024-04-11", "عطلة عيد الفطر (مقدرة)"),
            ("2024-04-12", "عطلة عيد الفطر (مقدرة)"),
            ("2024-05-01", "عيد العمال"),
            ("2024-05-25", "عيد الإستقلال"),
            ("2024-06-15", "يوم عرفة (مقدرة)"),
            ("2024-06-16", "عيد الأضحى (مقدرة)"),
            ("2024-06-17", "عطلة عيد الأضحى (مقدرة)"),
            ("2024-06-18", "عطلة عيد الأضحى (مقدرة)"),
            ("2024-07-07", "رأس السنة الهجرية (مقدرة)"),
            ("2024-09-15", "عيد المولد النبوي (مقدرة)"),
