        ...
        self.assertLocalizedHolidays(
            (
                ...
                (
                    "2023-06-18",
                    (
                        "HM Queen Norodom Monineath Sihanouk "
        ...
        self.assertLocalizedHolidays(
            (
                ...
                (
                    "2023-06-18",
                    (
                        "พระราชพิธีเฉลิมพระชนมพรรษา สมเด็จพระบรมราชินี "
                        "นโรดม มนีนาถ สีหนุ"
                    ),
                ),
                ...
                (
                    "2023-10-15",
                    (
                        "วันสดุดีพระบาทสมเด็จพระบรมนาถนโรดม สีหนุ "
                        "พระบิดาแห่งเอกราช บูรณภาพแห่งดินแดน "
                        "และเอกภาพของชาติกัมพูชา; "
                        "เทศกาลงานวันสาร์ทภจุมบิณฑ์เขมร"
                    ),
                ),
                (
                    "2023-10-29",
                    (
                        "พระราชพิธีเฉลิมฉลองการขึ้นครองราชสมบัติ "
                        "พระบาทสมเด็จพระบรมนาถ นโรดมสีหมุนี "
                ...
                (
                    "2023-11-26",
                    (
                        "พระราชพิธีบุญแข่งเรือลอยกระทงไฟไหว้พระจันทร์"
                        "และกินข้าวเม่า"
                    ),
                ),
                (
