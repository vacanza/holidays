...
from holidays.countries.united_states_virgin_islands import VI, VIR
from holidays.countries.united_states_virgin_islands import (
    UnitedStatesVirginIslands,
)
from holidays.countries.united_states_virgin_islands import HolidaysVI
...
class TestVI(unittest.TestCase):
    ...
    def setUp(self):
        self.holidays = country_holidays("VI")
    ...
    def test_aliases(self):
        ...
        for h in [VI(), VIR(), UnitedStatesVirginIslands()]:
            self.assertIsInstance(h, HolidaysVI)
