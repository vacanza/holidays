...
class TestRussia(CommonCountryTests, WorkingDayTests, TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_constitution_day(self):
        ...
        self.assertHolidayName(name, (f"{year}-12-12" for year in range(1994, 2005)))
        self.assertNoHolidayName(name, range(1991, 1994), range(2005, 2025))
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-11-05", "День народного единства (выходной)"),
    ...
    def test_l10n_th(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-11-05", "ชดเชยวันเอกภาพแห่งชาติ"),
    ...
    def test_l10n_zh_cn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-02-23", "祖国保卫者日"),
            ("2018-03-08", "国际妇女节"),
            ("2018-03-09", "休息日（由 2018-01-06 调休）"),
            ("2018-04-30", "休息日（由 2018-04-28 调休）"),
            ("2018-05-01", "春天与劳动节"),
            ("2018-05-02", "休息日（由 2018-01-07 调休）"),
            ("2018-05-09", "胜利日"),
            ("2018-06-11", "休息日（由 2018-06-09 调休）"),
            ("2018-06-12", "俄罗斯日"),
            ("2018-11-04", "人民团结日"),
            ("2018-11-05", "人民团结日（补假）"),
            ("2018-12-31", "休息日（由 2018-12-29 调休）"),
        )
