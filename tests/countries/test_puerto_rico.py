...
from holidays.countries import HolidaysPR, PR, PRI, PuertoRico
...
class TestPR(unittest.TestCase):
    ...
    def setUp(self):
        self.holidays = country_holidays("PR")
    ...
    def test_aliases(self):
        ...
        for h in [PR(), PRI(), PuertoRico()]:
            self.assertIsInstance(h, HolidaysPR)
