...
class TestDemocraticRepublicOfTheCongo(CommonCountryTests, TestCase):
    ...
    def test_2006(self):
        self.assertHolidays(
            ...
            ("2016-01-16", "Assassinat de Laurent-Désiré Kabila; Assassinat de Patrice Lumumba"),
    ...
    def test_2010(self):
        self.assertHolidays(
            ...
            ("2010-01-16", "Assassinat de Laurent-Désiré Kabila; Assassinat de Patrice Lumumba"),
    ...
    def test_2015(self):
        self.assertHolidays(
            ...
            ("2015-01-16", "Assassinat de Laurent-Désiré Kabila; Assassinat de Patrice Lumumba"),
    ...
    def test_2017(self):
        self.assertHolidays(
            ...
            ("2017-01-16", "Assassinat de Laurent-Désiré Kabila; Assassinat de Patrice Lumumba"),
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-01-16", "Assassinat de Laurent-Désiré Kabila; Assassinat de Patrice Lumumba"),
    ...
    def test_l10n_en_us(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-01-16", "Laurent-Désiré Kabila Assassination; Patrice Lumumba Assassination"),
