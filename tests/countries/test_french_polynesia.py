...
from holidays.countries.french_polynesia import FrenchPolynesia, PF, PYF
from tests.common import TestCase


class TestFrenchPolynesia(TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(FrenchPolynesia)

    def test_country_aliases(self):
        self.assertCountryAliases(FrenchPolynesia, PF, PYF)
