...
class TestBhutan(CommonCountryTests, TestCase):
    ...
    def test_death_of_zhabdrung(self):
        name = "མཐུ་ཆེན་བདུད་འཇོམས་རྡོ་རྗེ་དགོངས་རྫོགས་དུས་དྲན་ངལ་གསོ།"
        self.assertHolidayName(
            name,
            "2021-04-22",
            "2022-05-11",
    ...
    def test_2025(self):
        self.assertHolidaysInYear(
            ...
            ("2025-05-07", "མཐུ་ཆེན་བདུད་འཇོམས་རྡོ་རྗེ་དགོངས་རྫོགས་དུས་དྲན་ངལ་གསོ།"),
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-04-18", "མཐུ་ཆེན་བདུད་འཇོམས་རྡོ་རྗེ་དགོངས་རྫོགས་དུས་དྲན་ངལ་གསོ།"),
