...
class TestBhutan(CommonCountryTests, TestCase):
    ...
    def test_birthday_anniversary_of_his_majesty_the_king(self):
        name = "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"
    ...
    def test_day_of_offering(self):
        name = "སྔར་སྲོལ་འབུལ་བའི་ལོ་གསར་ངལ་གསོ།"
        self.assertHolidayName(
            name,
            "2020-01-25",
            "2021-01-14",
    ...
    def test_losar(self):
        name = "གནམ་ལོ་གསར་ཚེས་དུས་སྟོན་ངལ་གསོ།"
        self.assertHolidayName(
            name,
            "2020-02-24",
            "2021-02-12",
    ...
    def test_death_of_zhabdrung(self):
        name = "མཐུ་ཆེན་བདུད་འཇོམས་རྡོ་རྗེ་དགོངས་རྫོགས་དུས་དྲན་ངལ་གསོ། ༼ཞབས་དྲུང་སྐུ་མཆོད༽"
        self.assertHolidayName(
            name,
            "2021-04-22",
            "2022-05-11",
    ...
    def test_lord_buddha_parinirvana(self):
        name = "སངས་རྒྱས་བཅོམ་ལྡན་འདས་ཀྱི་དུས་ཆེན་ལྔ་འཛོམས་ངལ་གསོ།"
        self.assertHolidayName(
            name,
            "2020-06-05",
            "2021-05-26",
    ...
    def test_thimphu_drubchoe(self):
        name = "ཐིམ་རྫོང་ལྷ་མོའི་དངོས་འཆམ་མཇལ་རྒྱུའི་ངལ་གསོ། ༼ཐིམ་ཕུ་ལུ་རྐྱངམ་ཅིག༽"
    ...
    def test_thimphu_tshechu(self):
        name = "ཐིམ་ཕུ་ཚེས་བཅུའི་ངལ་གསོ། ༼ཐིམ་ཕུ་ལུ་རྐྱངམ་ཅིག༽"
    ...
    def test_2025(self):
        self.assertHolidaysInYear(
            2025,
            ("2025-01-02", "དགུན་ཉི་ལྡོག་གི་ངལ་གསོ།"),
            ("2025-01-30", "སྔར་སྲོལ་འབུལ་བའི་ལོ་གསར་ངལ་གསོ།"),
            ("2025-02-21", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2025-02-22", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2025-02-23", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2025-02-28", "གནམ་ལོ་གསར་ཚེས་དུས་སྟོན་ངལ་གསོ།"),
            ("2025-03-01", "གནམ་ལོ་གསར་ཚེས་དུས་སྟོན་ངལ་གསོ།"),
            ("2025-05-02", "མི་དབང་འབྲུག་རྒྱལ་གསུམ་པའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2025-05-07", "མཐུ་ཆེན་བདུད་འཇོམས་རྡོ་རྗེ་དགོངས་རྫོགས་དུས་དྲན་ངལ་གསོ། ༼ཞབས་དྲུང་སྐུ་མཆོད༽"),
            ("2025-06-11", "སངས་རྒྱས་བཅོམ་ལྡན་འདས་ཀྱི་དུས་ཆེན་ལྔ་འཛོམས་ངལ་གསོ།"),
            ...
            ("2025-11-01", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་གསེར་ཁྲི་མངའ་གསོལ་དུས་སྟོན་ངལ་གསོ།"),
            (
                "2025-11-11",
                "མི་དབང་འབྲུག་རྒྱལ་བཞི་པའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།; རྒྱལ་བ་ལྷ་ལས་བབས་པའི་དུས་ཆེན་ངལ་གསོ།",
            ),
            ("2025-12-17", "རྒྱལ་ཡོངས་དུས་ཆེན་ངལ་གསོ།"),
        )

    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ("2024-01-02", "དགུན་ཉི་ལྡོག་གི་ངལ་གསོ།"),
            ("2024-01-12", "སྔར་སྲོལ་འབུལ་བའི་ལོ་གསར་ངལ་གསོ།"),
            ("2024-02-10", "གནམ་ལོ་གསར་ཚེས་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-02-11", "གནམ་ལོ་གསར་ཚེས་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-02-21", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-02-22", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-02-23", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-04-18", "མཐུ་ཆེན་བདུད་འཇོམས་རྡོ་རྗེ་དགོངས་རྫོགས་དུས་དྲན་ངལ་གསོ། ༼ཞབས་དྲུང་སྐུ་མཆོད༽"),
            ("2024-05-02", "མི་དབང་འབྲུག་རྒྱལ་གསུམ་པའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-05-23", "སངས་རྒྱས་བཅོམ་ལྡན་འདས་ཀྱི་དུས་ཆེན་ལྔ་འཛོམས་ངལ་གསོ།"),
            ...
            ("2024-09-10", "ཐིམ་རྫོང་ལྷ་མོའི་དངོས་འཆམ་མཇལ་རྒྱུའི་ངལ་གསོ། ༼ཐིམ་ཕུ་ལུ་རྐྱངམ་ཅིག༽"),
            ("2024-09-13", "ཐིམ་ཕུ་ཚེས་བཅུའི་ངལ་གསོ། ༼ཐིམ་ཕུ་ལུ་རྐྱངམ་ཅིག༽"),
            ("2024-09-14", "ཐིམ་ཕུ་ཚེས་བཅུའི་ངལ་གསོ། ༼ཐིམ་ཕུ་ལུ་རྐྱངམ་ཅིག༽"),
            ("2024-09-15", "ཐིམ་ཕུ་ཚེས་བཅུའི་ངལ་གསོ། ༼ཐིམ་ཕུ་ལུ་རྐྱངམ་ཅིག༽"),
            ("2024-09-23", "རྒྱལ་ཡོངས་ཁྲུས་བབས་ངལ་གསོ།"),
            ("2024-10-12", "ལྷོ་མཚམས་ད་སའིན་ངལ་གསོ།"),
            ("2024-11-01", "མི་དབང་མངའ་བདག་རིན་པོ་ཆེའི་གསེར་ཁྲི་མངའ་གསོལ་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-11-11", "མི་དབང་འབྲུག་རྒྱལ་བཞི་པའི་འཁྲུངས་སྐར་དུས་སྟོན་ངལ་གསོ།"),
            ("2024-11-22", "རྒྱལ་བ་ལྷ་ལས་བབས་པའི་དུས་ཆེན་ངལ་གསོ།"),
            ("2024-12-17", "རྒྱལ་ཡོངས་དུས་ཆེན་ངལ་གསོ།"),
        )
