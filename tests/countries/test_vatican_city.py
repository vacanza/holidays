...
class TestVaticanCity(TestCase):
    ...
    def test_anniversary_election_of_holy_father(self):
        ...
        self.assertHolidaysName(name, (f"{year}-10-16" for year in range(1978, 2005)))
        self.assertHolidaysName(name, (f"{year}-04-19" for year in range(2005, 2013)))
        self.assertHolidaysName(name, (f"{year}-03-13" for year in range(2013, 2050)))
    ...
    def test_saint_georges_day(self):
        ...
        self.assertHolidaysName(name, (f"{year}-04-23" for year in range(2013, 2050)))
    ...
    def test_saint_joseph_workers_day(self):
        ...
        self.assertHolidaysName(name, (f"{year}-05-01" for year in range(1955, 2050)))
    ...
    def test_saint_charles_borromeo_day(self):
        ...
        self.assertHolidaysName(name, (f"{year}-11-04" for year in range(1978, 2005)))
