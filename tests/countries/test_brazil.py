...
class TestBrazil(unittest.TestCase):
    def test_BR_holidays(self):
        self.holidays = country_holidays("BR", years=2018)
    ...
    def test_AC_holidays(self):
        ac_holidays = country_holidays("BR", subdiv="AC")
    ...
    def test_AL_holidays(self):
        al_holidays = country_holidays("BR", subdiv="AL")
    ...
    def test_AP_holidays(self):
        ap_holidays = country_holidays("BR", subdiv="AP")
    ...
    def test_AM_holidays(self):
        am_holidays = country_holidays("BR", subdiv="AM")
    ...
    def test_BA_holidays(self):
        ba_holidays = country_holidays("BR", subdiv="BA")
    ...
    def test_CE_holidays(self):
        ce_holidays = country_holidays("BR", subdiv="CE")
    ...
    def test_DF_holidays(self):
        df_holidays = country_holidays("BR", subdiv="DF")
    ...
    def test_ES_holidays(self):
        es_holidays = country_holidays("BR", subdiv="ES")
    ...
    def test_GO_holidays(self):
        go_holidays = country_holidays("BR", subdiv="GO")
    ...
    def test_MA_holidays(self):
        ma_holidays = country_holidays("BR", subdiv="MA")
    ...
    def test_MT_holidays(self):
        mt_holidays = country_holidays("BR", subdiv="MT")
    ...
    def test_MS_holidays(self):
        ms_holidays = country_holidays("BR", subdiv="MS")
    ...
    def test_MG_holidays(self):
        mg_holidays = country_holidays("BR", subdiv="MG")
    ...
    def test_PA_holidays(self):
        pa_holidays = country_holidays("BR", subdiv="PA")
    ...
    def test_PB_holidays(self):
        pb_holidays = country_holidays("BR", subdiv="PB")
    ...
    def test_PE_holidays(self):
        pe_holidays = country_holidays("BR", subdiv="PE")
    ...
    def test_PI_holidays(self):
        pi_holidays = country_holidays("BR", subdiv="PI")
    ...
    def test_PR_holidays(self):
        pr_holidays = country_holidays("BR", subdiv="PR")
    ...
    def test_RJ_holidays(self):
        rj_holidays = country_holidays("BR", subdiv="RJ")
    ...
    def test_RN_holidays(self):
        rn_holidays = country_holidays("BR", subdiv="RN")
    ...
    def test_RS_holidays(self):
        rs_holidays = country_holidays("BR", subdiv="RS")
    ...
    def test_RO_holidays(self):
        ro_holidays = country_holidays("BR", subdiv="RO")
    ...
    def test_RR_holidays(self):
        rr_holidays = country_holidays("BR", subdiv="RR")
    ...
    def test_SC_holidays(self):
        ...
        sc_holidays = country_holidays("BR", subdiv="SC")
    ...
    def test_SP_holidays(self):
        sp_holidays = country_holidays("BR", subdiv="SP")
    ...
    def test_SE_holidays(self):
        se_holidays = country_holidays("BR", subdiv="SE")
    ...
    def test_TO_holidays(self):
        to_holidays = country_holidays("BR", subdiv="TO")
