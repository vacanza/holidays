...
class TestUnitedKingdom(CommonCountryTests, TestCase):
    ...
    def test_l10n_ur_gb(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-03-18", "سینٹ پیٹرک کا دن (مشاہدہ شدہ)"),
            ("2024-03-29", "جمعہ مبارک"),
            ("2024-04-01", "ایسٹر پیر"),
            ("2024-05-06", "یوم مئی"),
            ("2024-05-27", "موسم بہار کی بینک تعطیل"),
            ("2024-07-12", "جنگِ بوائن"),
            ("2024-08-05", "موسم گرما کی بینک تعطیل"),
            ("2024-08-26", "موسم گرما کے آخر کی بینک تعطیل"),
            ("2024-11-30", "سینٹ اینڈریو کا دن"),
            ("2024-12-02", "سینٹ اینڈریو کا دن (مشاہدہ شدہ)"),
