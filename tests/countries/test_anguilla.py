...
class TestAnguilla(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(Anguilla, years=range(2010, 2050))
    ...
    def test_new_years_day(self):
        self.assertHolidayName("New Year's Day", (f"{year}-01-01" for year in range(2010, 2050)))
    ...
    def test_labour_day(self):
        name = "Labour Day"
        self.assertHolidayName(name, (f"{year}-05-01" for year in range(2010, 2050)))
        dt = ("2010-05-03", "2011-05-02", "2016-05-02", "2021-05-03", "2022-05-02")
        self.assertHolidayName(f"{name} (observed)", dt)
        self.assertNoNonObservedHoliday(dt)
    ...
    def test_national_heroes_and_heroines_day(self):
        ...
        name = "Separation Day"
        self.assertHolidayName(name, "2010-12-19")
        dt = "2010-12-17"
        self.assertHolidayName(f"{name} (observed)", dt)
        self.assertNoNonObservedHoliday(dt)
    ...
    def test_christmas_day(self):
        name = "Christmas Day"
        self.assertHolidayName(name, (f"{year}-12-25" for year in range(2010, 2050)))

    def test_boxing_day(self):
        name = "Boxing Day"
        self.assertHolidayName(name, (f"{year}-12-26" for year in range(2010, 2050)))
    ...
    def test_special_holiday(self):
        ...
        name = "Special Public Holiday Day"
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2022-06-13", "Celebration of the Birthday of Her Majesty the Queen"),
