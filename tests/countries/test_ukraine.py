...
class TestUkraine(CommonCountryTests, WorkingDayTests, TestCase):
    ...
    def test_no_holidays(self):
        ...
        self.assertNoHolidays(Ukraine(years=range(2023, self.end_year)))
        self.assertNoHolidays(Ukraine(categories=WORKDAY, years=range(self.start_year, 2022)))
    ...
    def test_l10n_ar(self):
        self.assertLocalizedHolidays(
            "ar",
            ("2021-01-01", "رأس السنة الميلادية"),
            ("2021-01-07", "عيد الميلاد"),
            ("2021-01-08", "يوم عطلة (استبدل من 16/01/2021)"),
            ("2021-03-08", "يوم المراة العالمي"),
            ("2021-05-01", "عيد العمال"),
            ("2021-05-02", "عيد الفصح"),
            ("2021-05-03", "عيد العمال (يوم تعويضي)"),
            ("2021-05-04", "عيد الفصح (يوم تعويضي)"),
            ...
            ("2021-12-27", "عيد الميلاد (يوم تعويضي)"),
        )
