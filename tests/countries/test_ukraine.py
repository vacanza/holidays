...
class TestUkraine(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_2022(self):
        ...
        self.assertHolidays(
            ...
            ("2022-01-07", "Різдво Христове (за юліанським календарем)"),
    ...
    def test_2022_workday(self):
        self.assertHolidays(
            ...
            ("2022-12-25", "Різдво Христове (за григоріанським календарем)"),
        )
    ...
    def test_2023_workday(self):
        self.assertHolidays(
            ...
            ("2023-01-07", "Різдво Христове (за юліанським календарем)"),
