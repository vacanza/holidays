...
class TestUkraine(TestCase):
    ...
    def test_2021(self):
        ...
        self.assertHolidays(
            ...
            ("2021-01-08", "Вихідний день (перенесено з 16.01)"),
            ...
            ("2021-08-23", "Вихідний день (перенесено з 28.08)"),
            ("2021-08-24", "День незалежності України"),
            ("2021-10-14", "День захисників і захисниць України"),
            ("2021-10-15", "Вихідний день (перенесено з 23.10)"),
    ...
    def test_l10n_en_us(self):
        self.assertLocalizedHolidays(
            ...
            ("2021-01-08", "Day off (substituted from 1/16)"),
            ...
            ("2021-08-23", "Day off (substituted from 8/28)"),
            ("2021-08-24", "Independence Day"),
            ("2021-10-14", "Day of defenders of Ukraine"),
            ("2021-10-15", "Day off (substituted from 10/23)"),
    ...
    def test_l10n_ar(self):
        self.assertLocalizedHolidays(
            ...
            ("2021-01-08", "يوم عطلة (استبدل من 16/01)"),
            ...
            ("2021-08-23", "يوم عطلة (استبدل من 28/08)"),
            ("2021-08-24", "عيد استقلال أوكرانيا"),
            ("2021-10-14", "يوم المدافعين عن أوكرانيا"),
            ("2021-10-15", "يوم عطلة (استبدل من 23/10)"),
