    ...
    def test_l10n_ar(self):
        self.assertLocalizedHolidays(
            (
                ...
                ("2021-05-02", "عيد الفصح (عيد الفصح)"),
                ("2021-05-03", "(صادر) عيد العمال"),
                ("2021-05-04", "(صادر) عيد الفصح (عيد الفصح)"),
                (
                    "2021-05-09",
                ...
                (
                    "2021-05-10",
                    "(صادر) يوم النصر على النازية في الحرب"
                    " العالمية الثانية (يوم النصر)",
                ),
                ("2021-06-20", "الثالوث"),
                ("2021-06-21", "(صادر) الثالوث"),
                ...
                ("2021-12-27", "(صادر) عيد الميلاد (حسب التقويم الغريغوري)"),
            ),
            "ar",
        )
