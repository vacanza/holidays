...
class TestTokelau(CommonCountryTests, TestCase):
    ...
    def test_new_years(self):
        self.assertHolidayName("Aho Tau Fou", (f"{year}-01-01" for year in range(2003, 2050)))
    ...
    def test_tokehega_day(self):
        self.assertHolidayName(
            "Aho o te Tokehega", (f"{year}-09-03" for year in range(2003, 2050))
        )

    def test_christmas_day(self):
        self.assertHolidayName("Aho Kilihimahi", (f"{year}-12-25" for year in range(2003, 2050)))

    def test_boxing_day(self):
        self.assertHolidayName(
            "Tua-aho Kilihimahi", (f"{year}-12-26" for year in range(2003, 2050))
        )

    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ("2022-01-01", "Aho Tau Fou"),
