...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_bn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-05-01", "গুজরাট দিবস; শ্রমিক দিবস; মহারাষ্ট্র দিবস"),
            ("2018-05-09", "রবীন্দ্র জয়ন্তী"),
            ("2018-05-16", "সিকিম রাজ্য দিবস"),
            ...
            ("2018-12-01", "নাগাল্যান্ড রাজ্য উদ্বোধন দিবস"),
            ("2018-12-02", "অসম দিবস"),
