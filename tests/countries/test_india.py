...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_te(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-04-14", "డా. బి.ఆర్. అంబేద్కర్ జయంతి; పుత్తాండు (తమిళ నూతన సంవత్సరం); వైశాఖి"),
            ("2018-04-15", "పొహెలా బొయిషాఖ్; మహా విషువ సంక్రాంతి / పన సంక్రాంతి; హిమాచల్ దినోత్సవం"),
