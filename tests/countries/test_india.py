...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_kn(self):
        self.assertLocalizedHolidays(
            "kn",
            ("2018-01-13", "ಲೋಹ್ರಿ"),
            ("2018-01-14", "ಉತ್ತರಾಯಣ; ಉತ್ತರಾಯಣ ಪುಣ್ಯಕಾಲ, ಮಕರ ಸಂಕ್ರಾಂತಿ; ಪೊಂಗಲ್; ಮಾಘ್ ಬಿಹು / ಪೊಂಗಲ್"),
            ("2018-01-15", "ತಿರುವಳ್ಳುವರ್ ದಿನೋತ್ಸವ / ಮಟ್ಟು ಪೊಂಗಲ್"),
            ("2018-01-16", "ಉಳವರ್ ತಿರುನಾಲ್"),
            ("2018-01-24", "ಉತ್ತರ ಪ್ರದೇಶ ಅವತರಣ ದಿನೋತ್ಸವ"),
            ...
            ("2018-06-02", "ತೆಲಂಗಾಣ ಅವತರಣ ದಿನೋತ್ಸವ"),
            ...
            (
                "2018-11-01",
                "ಆಂಧ್ರ ಪ್ರದೇಶ ಅವತರಣ ದಿನೋತ್ಸವ; "
                "ಕನ್ನಡ ರಾಜ್ಯೋತ್ಸವ; "
                "ಕೇರಳ ಅವತರಣ ದಿನೋತ್ಸವ; "
                "ಛತ್ತೀಸ್‌ಗಢ ಅವತರಣ ದಿನೋತ್ಸವ; "
                "ಪಂಜಾಬ್ ದಿನೋತ್ಸವ; "
                "ಪುದುಚ್ಚೇರಿ ವಿಮೋಚನ ದಿನೋತ್ಸವ; "
                "ಮಧ್ಯ ಪ್ರದೇಶ ಅವತರಣ ದಿನೋತ್ಸವ; "
                "ಹರ್ಯಾಣ ಅವತರಣ ದಿನೋತ್ಸವ",
            ),
            ("2018-11-07", "ದೀಪಾವಳಿ"),
            ("2018-11-08", "ಗೋವರ್ಧನ ಪೂಜೆ"),
            ("2018-11-13", "ಛಠ್ ಪೂಜೆ"),
            ("2018-11-14", "ಮಕ್ಕಳ ದಿನಾಚರಣೆ"),
            ("2018-11-15", "ಜಾರ್ಖಂಡ್ ಅವತರಣ ದಿನೋತ್ಸವ"),
            ("2018-11-21", "ಈದ್ - ಮಿಲಾದ್"),
            ("2018-11-23", "ಗುರು ನಾನಕ್ ಜಯಂತಿ"),
            ("2018-12-01", "ನಾಗಾಲ್ಯಾಂಡ್ ರಾಜ್ಯ ಪ್ರಾರಂಭ ದಿನೋತ್ಸವ"),
