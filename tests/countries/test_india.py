...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_feast_of_st_francis_xavier(self):
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-03", "Feast of St. Francis Xavier"),
    ...
    def test_l10n_bn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-02", "অসম দিবস"),
            ("2018-12-03", "সেন্ট ফ্রান্সিস জেভিয়ারের ভোজ"),
    ...
    def test_l10n_gu(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-03", "સંત ફ્રાન્સિસ ઝેવિયરનો તહેવાર"),
    ...
    def test_l10n_hi(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-02", "असम दिवस"),
            ("2018-12-03", "फ़्रांसिस ज़ेवियर का पर्व"),
    ...
    def test_l10n_kn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-03", "ಸೇಂಟ್ ಫ್ರಾನ್ಸಿಸ್ ಕ್ಸೇವಿಯರ್ ಹಬ್ಬ"),
    ...
    def test_l10n_ml(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-02", "അസം ദിനം"),
            ("2018-12-03", "വിശുദ്ധ ഫ്രാൻസിസ് സേവ്യരുടെ പെരുന്നാൾ"),
    ...
    def test_l10n_mr(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-02", "आसाम दिन"),
            ("2018-12-03", "संत फ्रान्सिस झेवियरचा सण"),
    ...
    def test_l10n_pa(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-03", "ਸੰਤ ਫ੍ਰਾਂਸਿਸ ਜ਼ੇਵੀਅਰ ਦਾ ਤਿਓਹਾਰ"),
    ...
    def test_l10n_ta(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-03", "புனித பிரான்சிஸ் சேவியர் திருவிழா"),
    ...
    def test_l10n_te(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-12-03", "సెయింట్ ఫ్రాన్సిస్ జేవియర్ పండుగ"),
