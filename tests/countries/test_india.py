...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_remna_ni_(self):
        name = "Remna Ni (Peace Accord Day)"
        self.assertNoHolidayName(name)
        for subdiv, holidays in self.subdiv_holidays.items():
            if subdiv == "MZ":
                self.assertHolidayName(
                ...
                self.assertHolidayName(name, holidays, range(self.start_year, 1986))
            else:
                self.assertNoHolidayName(name, holidays)
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "Remna Ni (Peace Accord Day)"),
    ...
    def test_l10n_bn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "রেমনা নি (শান্তি চুক্তি দিবস)"),
            ("2018-07-14", "রথযাত্রা"),
            ("2018-08-06", "বোনালু"),
    ...
    def test_l10n_gu(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "રેમના ની (શાંતિ કરાર દિવસ)"),
    ...
    def test_l10n_hi(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "रेमना नी (शांति समझौता दिवस)"),
    ...
    def test_l10n_kn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "ರೆಮ್ನಾ ನೀ (ಶಾಂತಿ ಒಪ್ಪಂದ ದಿನ)"),
    ...
    def test_l10n_ml(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "റെമ്നാ നി (സമാധാന കരാർ ദിനം)"),
            ("2018-07-14", "രഥയാത്ര"),
            ("2018-08-06", "ബോനാലു"),
    ...
    def test_l10n_mr(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "रेमना नी (शांतता करार दिन)"),
            ("2018-07-14", "रथ यात्रा"),
            ("2018-08-06", "बोनालू"),
    ...
    def test_l10n_pa(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "ਰੇਮਨਾ ਨੀ (ਸ਼ਾਂਤੀ ਸਮਝੌਤਾ ਦਿਵਸ)"),
    ...
    def test_l10n_ta(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "ரெம்னா நீ (அமைதி ஒப்பந்த நாள்)"),
    ...
    def test_l10n_te(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-06-30", "రెమ్నా నీ (శాంతి ఒప్పంద దినోత్సవం)"),
            ("2018-07-14", "రథ యాత్ర"),
            ("2018-08-06", "బోనాలు"),
