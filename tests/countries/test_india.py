...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_te(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-01-15", "తిరువల్లువర్ రోజు / మాట్టు పొంగల్"),
            ("2018-01-16", "ఉజవర్ తిరునాల్"),
            ("2018-01-24", "ఉత్తర ప్రదేశ్ ఏర్పాటు రోజు"),
            ("2018-01-26", "గణతంత్ర దినోత్సవం"),
            ("2018-02-13", "మహా శివరాత్రి"),
            ("2018-02-19", "ఛత్రపతి శివాజీ మహారాజ్ జయంతి"),
            ("2018-02-20", "మిజోరం రాష్ట్ర రోజు"),
            ("2018-03-02", "హోలీ"),
            ("2018-03-18", "ఉగాది; గుడి పాడ్వా"),
            ("2018-03-22", "బీహార్ రోజు"),
            ("2018-03-25", "పామ్ ఆదివారం; రామ నవమి"),
            ("2018-03-29", "మహావీర్ జయంతి"),
            ("2018-03-30", "గుడ్ ఫ్రైడే; రాజస్థాన్ రోజు"),
            ("2018-04-01", "ఈస్టర్ ఆదివారం; ఒడిశా రోజు (ఉత్కల దిబాసా)"),
            ("2018-04-14", "డాక్టర్ బి.ఆర్. అంబేద్కర్ జయంతి; పుథాండు (తమిళ నూతన సంవత్సరం); వైసాఖి"),
            ("2018-04-15", "పోహేలా బోయిషాక్; మహా విషువ సంక్రాంతి / పానా సంక్రాంతి; హిమాచల్ రోజు"),
            ("2018-04-30", "బుద్ధ పౌర్ణమి"),
            ("2018-05-01", "కార్మికుల రోజు; గుజరాత్ రోజు; మహారాష్ట్ర రోజు"),
            ("2018-05-09", "రబీంద్ర జయంతి"),
            ("2018-05-16", "సిక్కిం రాష్ట్ర రోజు"),
            ("2018-06-02", "తెలంగాణ ఏర్పాటు రోజు"),
            ("2018-06-16", "ఈద్-ఉల్-ఫితర్; మహారాణా ప్రతాప్ జయంతి"),
            ("2018-08-15", "స్వాతంత్ర్య దినోత్సవం"),
            ("2018-08-16", "పుదుచ్చేరి చట్టబద్ధ బదిలీ రోజు"),
            ("2018-08-22", "బకరీద్"),
            ("2018-08-24", "ఓణం"),
            ("2018-08-26", "రక్షా బంధన్"),
            ("2018-09-03", "జన్మాష్టమి"),
            ...
            ("2018-10-17", "మహా నవమి"),
            ("2018-10-19", "విజయదశమి"),
            ("2018-10-31", "సర్దార్ వల్లభాయ్ పటేల్ జయంతి"),
            (
                "2018-11-01",
                "ఆంధ్ర ప్రదేశ్ రోజు; "
                "కర్ణాటక రాజ్యోత్సవ; "
            ...
            ("2018-11-13", "ఛాత్ పూజ"),
            ("2018-11-14", "పిల్లల రోజు"),
            ("2018-11-15", "ఝార్ఖండ్ ఏర్పాటు రోజు"),
            ("2018-11-21", "మిలాద్-ఉన్-నబీ"),
            ("2018-11-23", "గురు నానక్ జయంతి"),
            ("2018-12-01", "నాగాలాండ్ రాష్ట్ర ప్రారంభ రోజు"),
            ("2018-12-02", "అస్సాం రోజు"),
            ("2018-12-19", "గోవా విముక్తి రోజు"),
