...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_kl(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-03-25", "പാം ഞായർ; രാമ നവമി"),
            ("2018-03-29", "മഹാവീർ ജയന്തി"),
            ("2018-03-30", "ഗുഡ് ഫ്രൈഡേ; രാജസ്ഥാൻ ദിനം"),
            ("2018-04-01", "ഈസ്റ്റർ ഞായർ; ഒഡിഷ ദിനം (ഉത്കൽ ദിബസം)"),
            (
                "2018-04-14",
                "ഡോ. ബി. ആർ. അംബേദ്കർ ജയന്തി; പുത്താണ്ട് (തമിഴ് പുതുവർഷം); വൈശാഖി",
            ),
            (
                "2018-04-15",
            ...
            ("2018-05-01", "ഗുജറാത്ത് ദിനം; ശ്രമദിനം; മഹാരാഷ്ട്ര ദിനം"),
            ...
            (
                ...
                "കർണാടക രാജ്യോത്സവം; കേരള സ്ഥാപനദിനം; "
                "ഛത്തീസ്ഗഢ് സ്ഥാപനദിനം; പഞ്ചാബ് ദിനം; "
                "പുതുച്ചേരി മോചനദിനം; മധ്യപ്രദേശ് സ്ഥാപനദിനം; "
                "ഹരിയാന സ്ഥാപനദിനം",
            ),
            ("2018-11-07", "ദീപാവലി"),
