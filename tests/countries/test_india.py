...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            (
                ...
                "Meshadi (Tamil New Year's Day); "
                "Puthandu (Tamil New Year); Vaisakhi; Vishu",
            ),
            (
                "2018-04-15",
                "Bahag Bihu; "
    ...
    def test_l10n_en_us(self):
        self.assertLocalizedHolidays(
            ...
            (
                "2018-11-13",
                "Chhath Puja; Pratihar Shashthi or Surya Shashthi (Chhat Puja)",
            ),
            ("2018-11-15", "Jharkhand Formation Day"),
    ...
    def test_l10n_gu(self):
        self.assertLocalizedHolidays(
            ...
            (
                "2018-11-13",
                "છઠ પૂજા; પ્રતિહાર ષષ્ઠી અથવા સૂર્ય ષષ્ઠી (છટ પૂજા)",
            ),
    ...
    def test_l10n_ml(self):
        self.assertLocalizedHolidays(
            ...
            (
                "2018-11-13",
                "ഛഠ് പൂജ; പ്രതിഹാർ ഷഷ്ഠി അല്ലെങ്കിൽ സൂര്യ ഷഷ്ഠി (ഛത് പൂജ)",
            ),
    ...
    def test_l10n_pa(self):
        self.assertLocalizedHolidays(
            ...
            (
                "2018-11-13",
                "ਛੱਠ ਪੂਜਾ; ਪ੍ਰਤਿਹਾਰ ਸ਼ਸ਼ਠੀ ਜਾਂ ਸੂਰਜ ਸ਼ਸ਼ਠੀ (ਛਟ ਪੂਜਾ)",
            ),
    ...
    def test_l10n_ta(self):
        self.assertLocalizedHolidays(
            ...
            (
                "2018-11-13",
                "சத் பூஜை; பிரதிஹார் ஷஷ்டி அல்லது சூர்ய ஷஷ்டி (சட் பூஜை)",
            ),
    ...
    def test_l10n_te(self):
        self.assertLocalizedHolidays(
            ...
            (
                "2018-04-01",
                "ஹஸ்ரத் அலியின் பிறந்தநாள்; ఈస్టర్ ఆదివారం; ఒడిశా దినోత్సవం (ఉత్కల దివస)",
            ),
            (
                "2018-04-14",
                "விசு; "
            ...
            (
                "2018-04-15",
                "வைசாகதி; పొహెలా బొయిషాఖ్; బహగ్ బిహు; మహా విషువ సంక్రాంతి / పానా సంక్రాంతి; హిమాచల్ దినోత్సవం",
            ),
            ...
            (
                "2018-11-13",
                "ఛఠ్ పూజ; ప్రతిహార్ షష్ఠి లేదా సూర్య షష్ఠి (ఛత్ పూజ)",
            ),
