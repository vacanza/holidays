...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_bn(self):
        self.assertLocalizedHolidays(
            ...
            ("2018-03-02", "হোলি"),
            ("2018-03-18", "Chaitra Sukladi; Cheti Chand; উগাদি; গুড়ি পাড়ওয়া"),
            ...
            (
                "2018-04-01",
                "Hazarat Ali's Birthday; ইস্টার রবিবার; ওড়িশা দিবস (উৎকল দিবস)",
            ),
            (
                "2018-04-14",
                "Meshadi (Tamil New Year's Day); "
            ...
            (
                "2018-04-15",
                "Bahag Bihu; Vaisakhadi; পহেলা বৈশাখ; মহা বিষুব সংক্রান্তি / পানা সংক্রান্তি; হিমাচল দিবস",
            ),
