...
class TestIndia(CommonCountryTests, TestCase):
    ...
    def test_l10n_mr(self):
        self.assertLocalizedHolidays(
            "mr",
            ("2018-01-13", "लोहरी"),
            ("2018-01-14", "उत्तरायण; पोंगल; मकर संक्रांती; माघ बिहू"),
            ("2018-01-15", "तिरुवल्लुवर दिवस / मट्टू पोंगल"),
            ("2018-01-16", "उझावर थिरुनल"),
            ("2018-01-24", "यूपी स्थापना दिवस"),
            ("2018-01-26", "प्रजासत्ताक दिवस"),
            ("2018-02-13", "महाशिवरात्री"),
            ("2018-02-19", "छत्रपती शिवाजी महाराज जयंती"),
            ("2018-02-20", "मिझोराम राज्य दिवस"),
            ("2018-03-02", "होळी"),
            ("2018-03-18", "उगाडी; गुढीपाडवा"),
            ("2018-03-22", "बिहार दिवस"),
            ("2018-03-25", "पाम रविवार; रामनवमी"),
            ("2018-03-29", "महावीर जन्म कल्याणक"),
            ("2018-03-30", "गुड फ्रायडे; राजस्थान दिवस"),
            ("2018-04-01", "इस्टर रविवार; ओडिशा दिवस (उत्कल दिवस)"),
            (
                "2018-04-14",
                "डॉ. बाबासाहेब आंबेडकर जयंती; पुथंडू (तमिळ नवीन वर्ष); वैशाखी",
            ),
            (
                "2018-04-15",
                "पोहेला बोइशाख; महाविश्व संक्रांती / पण संक्रांती; हिमाचल दिवस",
            ),
            ("2018-04-30", "बुध्द पौर्णिमा"),
            ("2018-05-01", "कामगार दिवस; गुजरात दिवस; महाराष्ट्र दिवस"),
            ("2018-05-09", "रवींद्र जयंती"),
            ("2018-05-16", "सिक्कीम राज्य दिवस"),
            ("2018-06-02", "तेलंगणा स्थापना दिवस"),
            ("2018-06-16", "महाराणा प्रताप जयंती; रमझान ईद (ईद-उल-फितर)"),
            ("2018-08-15", "स्वातंत्र्य दिवस"),
            ("2018-08-16", "पुदुचेरी कायदेशीर हस्तांतरण दिवस"),
            ...
            ("2018-10-10", "नवरात्री / शरद नवरात्री"),
            ("2018-10-17", "महा नवमी"),
            ("2018-10-19", "दसरा"),
            ("2018-10-31", "सरदार वल्लभभाई पटेल जयंती"),
            (
                "2018-11-01",
                "आंध्र प्रदेश स्थापना दिवस; "
                "कर्नाटक राज्योत्सव; केरळ स्थापना दिवस; "
                "छत्तीसगड स्थापना दिवस; नवीन पंजाब दिवस; "
                "पुदुचेरी मुक्ती दिवस; मध्य प्रदेश स्थापना दिवस; "
                "हरियाणा स्थापना दिवस",
            ),
            ...
            ("2018-12-01", "नागालँड राज्य उद्घाटन दिवस"),
            ("2018-12-02", "आसाम दिवस"),
            ("2018-12-19", "गोवा मुक्ती दिवस"),
            ("2018-12-25", "ख्रिसमस"),
        )
