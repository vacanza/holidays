...
class TestCuracao(unittest.TestCase):
    def setUp(self):
        self.holidays = country_holidays("CW")
    ...
    def test_queens_day_between_1891_and_1948(self):
        ...
        self.holidays = country_holidays("CW", years=[1901])
    ...
    def test_labour_day(self):
        ...
        self.holidays = country_holidays("CW", years=[2017])
