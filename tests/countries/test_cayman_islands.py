...
class TestFalklandIslands(CommonCountryTests, TestCase):
    ...
    def setUpClass(cls):
        ...
        super().setUpClass(CaymanIslands, years=years, years_non_observed=years)

    def test_country_aliases(self):
        self.assertAliases(CaymanIslands, KY, CYM)

    def test_no_holidays(self):
        self.assertNoHolidays(CaymanIslands(years=2007))
    ...
    def test_new_years_day(self):
        name = "New Year's Day"
        self.assertHolidayName(name, (f"{year}-01-01" for year in range(2008, 2050)))
        obs_dt = (
            "2011-01-03",
            "2012-01-02",
            "2017-01-02",
    ...
    def test_general_election_day(self):
        ...
        self.assertHolidayName(name, "2009-05-20", "2017-05-24", "2021-04-14", "2025-04-30")
        self.assertNoHolidayName(
            name, [year for year in range(2008, 2050) if year not in (2009, 2017, 2021, 2025)]
        )
    ...
    def test_emancipation_day(self):
        ...
        self.assertNoHolidayName(name, range(2008, 2024))
    ...
    def test_queens_birthday(self):
        ...
        self.assertHolidayName(name, range(2008, 2023))
    ...
    def test_kings_birthday(self):
        ...
        self.assertNoHolidayName(name, range(2008, 2023))
    ...
    def test_christmas_day(self):
        name = "Christmas Day"
        self.assertHolidayName(name, (f"{year}-12-25" for year in range(2008, 2050)))
        obs_dt = (
            "2010-12-27",
            "2011-12-27",
            "2016-12-27",
    ...
    def test_boxing_day(self):
        name = "Boxing Day"
        self.assertHolidayName(name, (f"{year}-12-26" for year in range(2008, 2050)))
        obs_dt = (
            "2010-12-28",
            "2015-12-28",
            "2020-12-28",
