...
from holidays.countries.saint_barthelemy import SaintBarthelemy, BL, BLM
from tests.common import TestCase


class TestSaintBarthelemy(TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(SaintBarthelemy)

    def test_country_aliases(self):
        self.assertCountryAliases(SaintBarthelemy, BL, BLM)
