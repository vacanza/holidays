...
from holidays.countries import AS, ASM, AmericanSamoa, HolidaysAS
...
class TestAS(unittest.TestCase):
    ...
    def setUp(self):
        self.holidays = country_holidays("AS")
    ...
    def test_aliases(self):
        ...
        for h in [AS(), ASM(), AmericanSamoa()]:
            self.assertIsInstance(h, HolidaysAS)
