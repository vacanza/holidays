...
class TestAmericanSamoa(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2022-04-18", "American Samoa Flag Day (observed); Easter Sunday (observed)"),
    ...
    def test_l10n_th(self):
        self.assertLocalizedHolidays(
            ...
            ("2022-04-18", "ชดเชยวันธงชาติอเมริกันซามัว; ชดเชยวันอาทิตย์อีสเตอร์"),
            ("2022-05-08", "วันแม่"),
            ("2022-05-30", "วันรำลึก"),
