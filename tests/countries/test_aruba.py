...
class TestAruba(unittest.TestCase):
    def setUp(self):
        self.holidays = country_holidays("AW")
    ...
    def test_queens_day_between_1891_and_1948(self):
        ...
        self.holidays = country_holidays("AW", years=[1901])
