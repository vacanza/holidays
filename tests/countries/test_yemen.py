...
class TestYemen(CommonCountryTests, TestCase):
    ...
    def test_no_holidays(self):
        self.assertNoHolidays(Yemen(years=1989))
    ...
    def test_unity_day(self):
        ...
        self.assertHolidayName(name, (f"{year}-05-22" for year in range(1990, 2050)))

    def test_revolution_day(self):
        name = "ثورة 26 سبتمبر المجيدة"
        self.assertHolidayName(name, (f"{year}-09-26" for year in range(1990, 2050)))

    def test_liberation_day(self):
        name = "ثورة 14 أكتوبر المجيدة"
        self.assertHolidayName(name, (f"{year}-10-14" for year in range(1990, 2050)))

    def test_independence_day(self):
        name = "عيد الجلاء"
        self.assertHolidayName(name, (f"{year}-11-30" for year in range(1990, 2050)))
    ...
    def test_l10n_default(self):
        self.assertLocalizedHolidays(
            ...
            ("2023-07-19", "عيد راس السنة الهجرية"),
