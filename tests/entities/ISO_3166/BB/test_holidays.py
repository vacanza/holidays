...
from holidays.entities.ISO_3166.BB import BbHolidays
from tests.common import CommonCountryTests


class TestBbHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(
            BbHolidays, years=range(1969, 2050), years_non_observed=range(2000, 2024)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(BbHolidays(years=1968))
