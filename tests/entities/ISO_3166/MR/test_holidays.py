...
from holidays.entities.ISO_3166.MR import MrHolidays
from tests.common import CommonCountryTests


class TestMrHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(MrHolidays, years=range(1950, 2050))
