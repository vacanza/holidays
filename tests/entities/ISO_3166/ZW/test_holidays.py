...
from holidays.entities.ISO_3166.ZW import ZwHolidays
...
class TestZimbabwe(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(ZwHolidays, years=range(1988, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(ZwHolidays(years=1987))
