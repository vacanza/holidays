...
from holidays.entities.ISO_3166.MV import MvHolidays
from tests.common import CommonCountryTests


class TestMvHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(MvHolidays, years=range(1950, 2050))
