...
from holidays.entities.ISO_3166.PA import PaHolidays
from tests.common import CommonCountryTests


class TestPaHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(PaHolidays, years=range(1950, 2050))
