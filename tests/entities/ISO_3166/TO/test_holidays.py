...
class TestToHolidays(CommonCountryTests, TestCase):
    ...
    def setUpClass(cls):
        super().setUpClass(
            ToHolidays, years=range(1989, 2050), years_non_observed=range(1989, 2050)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(ToHolidays(years=1988))
