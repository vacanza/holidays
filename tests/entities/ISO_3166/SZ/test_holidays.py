...
from holidays.entities.ISO_3166.SZ import SzHolidays
from tests.common import CommonCountryTests


class TestSzHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(SzHolidays, years=range(1939, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(SzHolidays(years=1938))
