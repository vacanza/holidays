...
from holidays.entities.ISO_3166.SV import SvHolidays
from tests.common import CommonCountryTests


class TestSvHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(SvHolidays, years=range(2000, 2050))
    ...
    def test_ss_holidays(self):
        ...
        ss_holidays = SvHolidays(subdiv="SS", years=range(2000, 2050))
