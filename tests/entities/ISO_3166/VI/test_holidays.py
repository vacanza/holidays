...
from holidays.entities.ISO_3166.VI import ViHolidays
from tests.common import CommonCountryTests


class TestViHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(ViHolidays)
    ...
    def test_unofficial_holidays(self):
        self.assertHolidays(
            ViHolidays(categories=UNOFFICIAL, years=2024),
