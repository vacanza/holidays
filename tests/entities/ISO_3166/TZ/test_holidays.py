...
class TestTanzania(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(TzHolidays, years=range(1994, 2077))

    def test_no_holidays(self):
        self.assertNoHolidays(TzHolidays(years=1993))
        self.assertNoHolidays(TzHolidays(years=1993, categories=BANK))
    ...
    def test_2018_all(self):
        self.assertHolidays(
            TzHolidays(categories=(BANK, PUBLIC), years=2018),
    ...
    def test_2020_all(self):
        self.assertHolidays(
            TzHolidays(categories=(BANK, PUBLIC), years=2020),
    ...
    def test_2021_all(self):
        self.assertHolidays(
            TzHolidays(categories=(BANK, PUBLIC), years=2021),
    ...
    def test_2022_all(self):
        self.assertHolidays(
            TzHolidays(categories=(BANK, PUBLIC), years=2022),
