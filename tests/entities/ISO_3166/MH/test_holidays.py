...
from holidays.entities.ISO_3166.MH import MhHolidays
from tests.common import CommonCountryTests


class TestMhHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(MhHolidays)

    def test_2020(self):
        # http://web.archive.org/web/20201125072002/https://www.pscrmi.net/rmi-holiday-memos
        self.assertHolidays(
            MhHolidays(years=2020),
