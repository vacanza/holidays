...
class TestUsHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(
            UsHolidays, years=range(1865, 2050), years_non_observed=range(2000, 2024)
        )
        cls.state_hols = {
            subdiv: UsHolidays(subdiv=subdiv, years=range(1865, 2050))
            for subdiv in UsHolidays.subdivisions
        }
    ...
    def test_martin_luther_king_day(self):
        ...
        for subdiv in set(UsHolidays.subdivisions) - {"AL", "AR", "AZ", "GA", "ID", "MS", "NH"}:
    ...
    def test_washingtons_birthday(self):
        ...
        for subdiv in set(UsHolidays.subdivisions) - subdiv_dont:
            self.assertHolidayName(name, self.state_hols[subdiv], dt)
    ...
    def test_inauguration_day(self):
        ...
        for subdiv in ("DC", "LA", "MD", "VA"):
            ...
            self.assertHolidayName(name, UsHolidays(subdiv=subdiv), "1789-03-04")
            self.assertNoHolidayName(name, UsHolidays(subdiv=subdiv), "1788-03-04")
            ...
            self.assertNoNonObservedHolidayName(
                f"{name} (observed)", UsHolidays(subdiv=subdiv, observed=False), obs_dt
            )
    ...
    def test_lincolns_birthday(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="CA", observed=False), obs_dt
        )
    ...
    def test_mardi_gras(self):
        name = "Mardi Gras"
        self.assertNoHolidayName(name)
        self.assertNoHolidayName(name, UsHolidays(subdiv="LA", years=1856))
        dt = (
            "2010-02-16",
            "2011-03-08",
            "2012-02-21",
    ...
    def test_town_meeting_day(self):
        ...
        self.assertNoHolidayName(name)
        self.assertNoHolidayName(name, UsHolidays(subdiv="VT", years=1799))
        dt = (
            "2010-03-02",
            "2011-03-01",
            "2012-03-06",
    ...
    def test_evacuation_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="MA", observed=False), obs_dt
        )
    ...
    def test_emancipation_day_in_puerto_rico(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="PR", observed=False), obs_dt
        )
    ...
    def test_commonwealth_covenant_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="MP", observed=False), obs_dt
        )
    ...
    def test_prince_jonah_kuhio_kalanianaole_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="HI", observed=False), obs_dt
        )
    ...
    def test_emancipation_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="DC", observed=False), obs_dt
        )
    ...
    def test_truman_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="MO", observed=False), obs_dt
        )
    ...
    def test_west_virginia_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="WV", observed=False), obs_dt
        )
    ...
    def test_pioneer_day(self):
        ...
        self.assertNoHolidayName(name, UsHolidays(subdiv="UT", years=1848))
        obs_dt = (
            "2010-07-23",
            "2011-07-25",
            "2016-07-25",
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="UT", observed=False), obs_dt
        )
    ...
    def test_bennington_battle_day(self):
        ...
        self.assertNoHolidayName(name, UsHolidays(subdiv="VT", years=1777))
        obs_dt = (
            "2009-08-17",
            "2014-08-15",
            "2015-08-17",
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="VT", observed=False), obs_dt
        )
    ...
    def test_alaska_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="AK", observed=False), obs_dt
        )
    ...
    def test_nevada_day(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="NV", observed=False), obs_dt
        )
    ...
    def test_election_day(self):
        ...
        for subdiv in set(UsHolidays.subdivisions) - subdiv_us_territories:
            self.assertNoHolidayName(
                name, UsHolidays(subdiv=subdiv, categories=UNOFFICIAL, years=(1844, 1847))
            )
            self.assertHolidayName(
                name,
                UsHolidays(subdiv=subdiv, categories=UNOFFICIAL),
                dt,
            )
        for subdiv in subdiv_us_territories:
            self.assertNoHolidayName(
                name, UsHolidays(subdiv=subdiv, categories=UNOFFICIAL, years=range(1865, 2050))
            )

    def test_valentines_day(self):
        name = "Valentine's Day"
        self.assertNoHolidayName(name)
        self.assertNoHolidayName(name, UsHolidays(categories=UNOFFICIAL, years=1846))
        self.assertHolidayName(
            name,
            UsHolidays(categories=UNOFFICIAL),
    ...
    def test_day_after_christmas(self):
        ...
        self.assertNoNonObservedHolidayName(
            f"{name} (observed)", UsHolidays(subdiv="NC", observed=False), obs_dt
        )
