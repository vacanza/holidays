...
from holidays.entities.ISO_3166.AU import AuHolidays
from tests.common import CommonCountryTests


class TestAuHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        years = range(1900, 2050)
        super().setUpClass(AuHolidays, years=years)
        cls.subdiv_holidays = {
            subdiv: AuHolidays(subdiv=subdiv, years=years) for subdiv in AuHolidays.subdivisions
        }

    def _assertVariableDays(self, year: int, subdiv_holidays: dict):  # noqa: N802
        observed_prov_holidays = {
            subdiv: AuHolidays(subdiv=subdiv, years=year) for subdiv in AuHolidays.subdivisions
        }
    ...
    def test_australia_day(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"NSW", "SA"}:
            ...
            self.assertNoHolidayName(name_1, AuHolidays(subdiv=subdiv, years=1887))
        ...
        self.assertNoHolidayName(name_1, AuHolidays(subdiv="NSW", years=1887))
    ...
    def test_sovereigns_birthday(self):
        ...
        for subdiv in AuHolidays.subdivisions:
            self.assertHolidayName(
                name_king,
                self.subdiv_holidays[subdiv],
    ...
    def test_canberra_day(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"ACT"}:
            self.assertNoHolidayName(name, self.subdiv_holidays[subdiv])
    ...
    def test_bank_holiday(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"NSW"}:
            self.assertNoHolidayName(name, self.subdiv_holidays[subdiv])
        self.assertHolidayName(name, AuHolidays(subdiv="NSW", categories=BANK), dt_bank)
    ...
    def test_picnic_day(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"NT"}:
            self.assertNoHolidayName(name, self.subdiv_holidays[subdiv])
    ...
    def test_royal_queensland_show(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"QLD"}:
            self.assertNoHolidayName(name, self.subdiv_holidays[subdiv])
    ...
    def test_adelaide_cup_day(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"SA"}:
            self.assertNoHolidayName(name, self.subdiv_holidays[subdiv])
    ...
    def test_melbourne_cup_day(self):
        ...
        for subdiv in set(AuHolidays.subdivisions) - {"VIC"}:
            self.assertNoHolidayName(name, self.subdiv_holidays[subdiv])
    ...
    def test_western_australia_day(self):
        ...
        self.assertNoHolidayName(name_1, AuHolidays(subdiv="WA", years=1832))

        for subdiv in set(AuHolidays.subdivisions) - {"WA"}:
    ...
    def test_special_holidays(self):
        ...
        self.assertNoNonObservedHoliday(
            AuHolidays(subdiv="QLD", observed=False, years=(2010, 2011)),
            "2010-12-28",
            "2011-01-03",
        )
