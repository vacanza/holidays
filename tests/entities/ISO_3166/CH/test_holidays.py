...
class TestChHolidays(CommonCountryTests, TestCase):
    ...
    def setUpClass(cls):
        ...
        super().setUpClass(ChHolidays, years=years)
        cls.prov_hols = {
            prov: ChHolidays(subdiv=prov, years=years) for prov in ChHolidays.subdivisions
        }
        cls.prov_hols_optional = {
            prov: ChHolidays(categories=OPTIONAL, subdiv=prov, years=years)
            for prov in ChHolidays.subdivisions
        }

    def test_all_holidays_present(self):
        y_2018 = set()
        for p in ChHolidays.subdivisions:
            y_2018.update(
                ChHolidays(categories=(HALF_DAY, OPTIONAL, PUBLIC), years=2018, subdiv=p).values()
            )
    ...
    def test_nafels_ride(self):
        ...
        self.assertNoHolidayName(name, ChHolidays(subdiv="GL", years=1834))
    ...
    def test_good_friday(self):
        ...
        provinces_that_have = (
            set(ChHolidays.subdivisions) - provinces_that_dont - provinces_optional
        )
    ...
    def test_labor_day(self):
        ...
        self.assertHolidayName(
            name,
            ChHolidays(categories=HALF_DAY, subdiv="SO", years=range(1970, 2050)),
