...
class TestTlHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(TlHolidays, years=range(2006, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(TlHolidays(years=2005))
        self.assertNoHolidays(TlHolidays(years=2005, categories=GOVERNMENT))
        self.assertNoHolidays(TlHolidays(years=2005, categories=WORKDAY))

    def test_special_government_holidays(self):
        self.assertHoliday(
            TlHolidays(categories=GOVERNMENT),
            "2010-11-03",
            "2010-12-24",
            "2010-12-31",
            "2011-08-15",
    ...
    def test_2011_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2011),
    ...
    def test_2012_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2012),
    ...
    def test_2013_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2013),
    ...
    def test_2014_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2014),
    ...
    def test_2015_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2015),
    ...
    def test_2016_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2016),
    ...
    def test_2017_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2017),
    ...
    def test_2018_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2018),
    ...
    def test_2019_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2019),
    ...
    def test_2020_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2020),
    ...
    def test_2021_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2021),
    ...
    def test_2022_public(self):
        self.assertHolidays(
            TlHolidays(categories=PUBLIC, years=2022),
    ...
    def test_2022_workday(self):
        self.assertHolidays(
            TlHolidays(categories=WORKDAY, years=2022),
    ...
    def test_2023_workday(self):
        self.assertHolidays(
            TlHolidays(categories=WORKDAY, years=2023),
