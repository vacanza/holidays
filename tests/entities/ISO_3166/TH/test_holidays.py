...
class TestThHolidays(CommonCountryTests, TestCase):
    ...
    def setUpClass(cls):
        super().setUpClass(
            ThHolidays, years=range(1941, 2058), years_non_observed=range(1941, 2058)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(ThHolidays(years=1940))
        self.assertNoHolidays(ThHolidays(years=1958, categories=ARMED_FORCES))
        self.assertNoHolidays(ThHolidays(years=1942, categories=BANK))
        self.assertNoHolidays(ThHolidays(years=1956, categories=GOVERNMENT))
        self.assertNoHolidays(ThHolidays(years=1956, categories=SCHOOL))
        self.assertNoHolidays(ThHolidays(years=1940, categories=WORKDAY))
    ...
    def test_2022_all(self):
        self.assertHolidays(
            ThHolidays(categories=(ARMED_FORCES, GOVERNMENT, PUBLIC, SCHOOL, WORKDAY), years=2022),
    ...
    def test_rama_five_memorial_day(self):
        ...
        self.assertNoHolidayName(name, ThHolidays(years=[1910, 1940]))
    ...
    def test_makha_bucha(self):
        ...
        self.assertHolidayName(name, dt)
        self.assertNoHolidayName(name, ThHolidays(years=2058))
    ...
    def test_raeknakhwan(self):
        name = "วันพืชมงคล"
        self.assertHolidays(
            ThHolidays(categories=GOVERNMENT, years=range(1960, 2024)),
            ("1960-05-02", name),
            ("1961-05-11", name),
            ("1962-05-07", name),
            ("1963-05-10", name),
    ...
    def test_armed_forces_holiday(self):
        name = "วันกองทัพไทย"
        self.assertHolidays(
            ThHolidays(categories=ARMED_FORCES, years=range(1958, 1960)), ("1959-04-08", name)
        )
        self.assertHolidays(
            ThHolidays(categories=ARMED_FORCES, years=range(1979, 1981)),
            ("1979-04-08", name),
            ("1980-01-25", name),
        )
        self.assertHolidays(
            ThHolidays(categories=ARMED_FORCES, years=range(2006, 2008)),
            ("2006-01-25", name),
            ("2007-01-18", name),
        )
    ...
    def test_bank_holiday(self):
        ...
        # Start
        self.assertHolidays(
            ThHolidays(categories=BANK, years=range(1942, 1944)),
            ("1943-04-01", a_name),
            ("1943-07-01", m_name),
        )
        # End
        self.assertHolidays(
            ThHolidays(categories=BANK, years=range(2017, 2023)),
            ("2017-04-01", a_name),
            ("2017-07-01", m_name),
            ("2018-04-01", a_name),
            ("2018-07-01", m_name),
    ...
    def test_school_holiday(self):
        self.assertHolidays(
            ThHolidays(categories=SCHOOL, years=range(1956, 1958)),
            ("1957-01-16", "วันครู"),
        )

    def test_workday_1947(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1947),
            ("1947-11-27", "วันลอยกระทง"),
        )

    def test_workday_1948(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1948),
    ...
    def test_workday_1982(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1982),
    ...
    def test_workday_1985(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1985),
    ...
    def test_workday_1989(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1989),
    ...
    def test_workday_1990(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1990),
    ...
    def test_workday_1995(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1995),
    ...
    def test_workday_1999(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=1999),
    ...
    def test_workday_2017(self):
        self.assertHolidays(
            ThHolidays(categories=WORKDAY, years=2017),
