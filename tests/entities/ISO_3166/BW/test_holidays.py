...
from holidays.entities.ISO_3166.BW import BwHolidays
from tests.common import CommonCountryTests


class TestBwHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(
            BwHolidays, years=range(1966, 2050), years_non_observed=range(2010, 2024)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(BwHolidays(years=1965))
