...
class TestKrHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(KrHolidays, years=range(1948, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(KrHolidays(years=1947))
        self.assertNoHolidays(KrHolidays(categories=BANK, years=1947))
    ...
    def test_workers_day(self):
        name = "근로자의날"
        holidays = KrHolidays(categories=BANK, years=range(1990, 2050))
    ...
    def test_2020_all(self):
        self.assertHolidays(
            KrHolidays(categories=(BANK, PUBLIC), years=2020),
            ("2020-01-01", "신정연휴"),
            ("2020-01-24", "설날 전날"),
            ("2020-01-25", "설날"),
            ("2020-01-26", "설날 다음날"),
