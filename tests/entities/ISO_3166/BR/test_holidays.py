...
from holidays.entities.ISO_3166.BR import BrHolidays
from tests.common import CommonCountryTests


class TestBrHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(BrHolidays, years=range(1890, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(BrHolidays(categories=(OPTIONAL, PUBLIC), years=1889))
    ...
    def test_optional_holidays(self):
        holidays = BrHolidays(categories=OPTIONAL)
        dt = (
            "2018-02-12",
            "2018-02-13",
            "2019-03-04",
    ...
    def test_ac_holidays(self):
        ac_holidays = BrHolidays(subdiv="AC", years=range(1995, 2030))
        for name in (
            "Dia do Evangélico",
    ...
    def test_al_holidays(self):
        al_holidays = BrHolidays(subdiv="AL", years=range(1995, 2030))
        for name in (
            "São João",
            "São Pedro",
    ...
    def test_am_holidays(self):
        am_holidays = BrHolidays(subdiv="AM", years=range(1995, 2030))
    ...
    def test_ap_holidays(self):
        ap_holidays = BrHolidays(subdiv="AP", years=range(1995, 2030))
    ...
    def test_ba_holidays(self):
        ba_holidays = BrHolidays(subdiv="BA", years=range(1995, 2030))
    ...
    def test_ce_holidays(self):
        ce_holidays = BrHolidays(subdiv="CE", years=range(1995, 2030))
    ...
    def test_df_holidays(self):
        df_holidays = BrHolidays(subdiv="DF", years=range(1995, 2030))
    ...
    def test_es_holidays(self):
        es_holidays = BrHolidays(subdiv="ES", years=range(1995, 2030))
    ...
    def test_go_holidays(self):
        go_holidays = BrHolidays(subdiv="GO", years=range(1995, 2030))
    ...
    def test_ma_holidays(self):
        ma_holidays = BrHolidays(subdiv="MA", years=range(1995, 2030))
    ...
    def test_mg_holidays(self):
        mg_holidays = BrHolidays(subdiv="MG", years=range(1995, 2030))
    ...
    def test_ms_holidays(self):
        ms_holidays = BrHolidays(subdiv="MS", years=range(1995, 2030))
    ...
    def test_mt_holidays(self):
        mt_holidays = BrHolidays(subdiv="MT", years=range(1995, 2030))
    ...
    def test_pa_holidays(self):
        pa_holidays = BrHolidays(subdiv="PA", years=range(1995, 2030))
    ...
    def test_pb_holidays(self):
        pb_holidays = BrHolidays(subdiv="PB", years=range(1995, 2030))
    ...
    def test_pe_holidays(self):
        pe_holidays = BrHolidays(subdiv="PE", years=range(1995, 2030))
    ...
    def test_pi_holidays(self):
        pi_holidays = BrHolidays(subdiv="PI", years=range(1995, 2030))
    ...
    def test_pr_holidays(self):
        pr_holidays = BrHolidays(subdiv="PR", years=range(1995, 2030))
    ...
    def test_rj_holidays(self):
        rj_holidays = BrHolidays(subdiv="RJ", years=range(1995, 2030))
    ...
    def test_rn_holidays(self):
        rn_holidays = BrHolidays(subdiv="RN", years=range(1995, 2030))
    ...
    def test_ro_holidays(self):
        ro_holidays = BrHolidays(subdiv="RO", years=range(1995, 2030))
    ...
    def test_rr_holidays(self):
        rr_holidays = BrHolidays(subdiv="RR", years=range(1995, 2030))
    ...
    def test_rs_holidays(self):
        rs_holidays = BrHolidays(subdiv="RS", years=range(1995, 2030))
    ...
    def test_sc_holidays(self):
        sc_holidays = BrHolidays(subdiv="SC", years=range(1995, 2030))
    ...
    def test_se_holidays(self):
        se_holidays = BrHolidays(subdiv="SE", years=range(1995, 2030))
    ...
    def test_sp_holidays(self):
        sp_holidays = BrHolidays(subdiv="SP", years=range(1995, 2030))
    ...
    def test_to_holidays(self):
        to_holidays = BrHolidays(subdiv="TO", years=range(1995, 2030))
