...
from holidays.entities.ISO_3166.BS import BsHolidays
from tests.common import CommonCountryTests


class TestBsHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(
            BsHolidays, years=range(1974, 2050), years_non_observed=range(1974, 2050)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(BsHolidays(years=1973))
