...
from holidays.entities.ISO_3166.IM import ImHolidays
from tests.common import CommonCountryTests


class TestImHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(ImHolidays, years=range(1970, 2070))

    def test_1970(self):
        self.assertHolidays(
            ImHolidays(years=1970),
