...
from holidays.entities.ISO_3166.IE import IeHolidays
from tests.common import CommonCountryTests


class TestIeHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(IeHolidays, years=range(1900, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(IeHolidays(years=1871))
