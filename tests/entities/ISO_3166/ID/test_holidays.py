...
class TestIdHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(IdHolidays, years=range(1946, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(IdHolidays(years=1945))
    ...
    def test_special_government(self):
        self.assertHoliday(
            IdHolidays(categories=GOVERNMENT),
            "2022-04-29",
            "2022-05-04",
            "2022-05-05",
            "2022-05-06",
