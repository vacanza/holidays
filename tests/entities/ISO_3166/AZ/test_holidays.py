...
class TestAzHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(AzHolidays, years=range(1990, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(AzHolidays(categories=(PUBLIC, WORKDAY), years=1989))
    ...
    def test_memorial_day(self):
        name = "Anım Günü"
        workday_holidays = AzHolidays(categories=WORKDAY, years=range(1990, 2050))
        self.assertHolidayName(
    ...
    def test_2022_workday(self):
        self.assertHolidays(
            AzHolidays(categories=WORKDAY, years=2022),
