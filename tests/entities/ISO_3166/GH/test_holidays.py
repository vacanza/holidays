...
from holidays.entities.ISO_3166.GH import GhHolidays
from tests.common import CommonCountryTests


class TestGhHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(GhHolidays, years=range(1957, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(GhHolidays(years=1956))
