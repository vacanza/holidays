...
class TestTwHolidays(CommonCountryTests, TestCase):
    ...
    def setUpClass(cls):
        ...
        super().setUpClass(TwHolidays, years=years, years_non_observed=years)

    def test_no_holidays(self):
        self.assertNoHolidays(TwHolidays(years=1911))
    ...
    def test_childrens_day(self):
        ...
        self.assertNoHolidayName(name, TwHolidays(years=1989))
    ...
    def test_tomb_sweeping_day(self):
        ...
        self.assertNoHolidayName(name, TwHolidays(years=1971))
