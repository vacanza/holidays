...
from holidays.entities.ISO_3166.AL import AlHolidays
from tests.common import CommonCountryTests


class TestAlHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(AlHolidays, years=range(1990, 2050))
