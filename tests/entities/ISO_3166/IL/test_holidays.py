...
class TestIlHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(IlHolidays, years=range(1948, 2050))
        cls.opt_holidays = IlHolidays(categories=(OPTIONAL,), years=range(2000, 2024))
        cls.opt_holidays_non_observed = IlHolidays(
            observed=False, categories=(OPTIONAL,), years=range(2000, 2024)
        )

    def test_not_implemented(self):
        self.assertRaises(NotImplementedError, lambda: IlHolidays(years=2101))
        self.assertRaises(
            NotImplementedError, lambda: IlHolidays(categories=(OPTIONAL,), years=2101)
        )
        self.assertRaises(
            NotImplementedError, lambda: IlHolidays(categories=(SCHOOL,), years=2101)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(IlHolidays(years=1947))
        self.assertNoHolidays(IlHolidays(categories=(OPTIONAL,), years=1947))
        self.assertNoHolidays(IlHolidays(categories=(SCHOOL,), years=1947))
    ...
    def test_memorial_day(self):
        ...
        self.assertNoHolidayName(name, IlHolidays(categories=(OPTIONAL,), years=range(1948, 1963)))
    ...
    def test_taanit_ester(self):
        ...
        school_holidays = IlHolidays(categories=(SCHOOL,), years=range(2000, 2024))
        school_holidays_non_observed = IlHolidays(
    ...
    def test_2021_optional(self):
        self.assertHolidays(
            IlHolidays(categories=(OPTIONAL,), years=2021),
            ("2021-02-26", "פורים"),
    ...
    def test_2022_optional(self):
        self.assertHolidays(
            IlHolidays(categories=(OPTIONAL,), years=2022),
            ("2022-03-17", "פורים"),
    ...
    def test_2023_optional(self):
        self.assertHolidays(
            IlHolidays(categories=(OPTIONAL,), years=2023),
            ("2023-03-07", "פורים"),
    ...
    def test_2021_school(self):
        self.assertHolidays(
            IlHolidays(categories=(SCHOOL,), years=2021),
    ...
    def test_2022_school(self):
        self.assertHolidays(
            IlHolidays(categories=(SCHOOL,), years=2022),
    ...
    def test_2023_school(self):
        self.assertHolidays(
            IlHolidays(categories=(SCHOOL,), years=2023),
