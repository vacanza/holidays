...
from holidays.entities.ISO_3166.ZA import ZaHolidays
from tests.common import CommonCountryTests


class TestZaHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(ZaHolidays, years=range(1940, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(ZaHolidays(years=1909))
