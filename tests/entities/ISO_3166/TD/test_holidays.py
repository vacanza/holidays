...
from holidays.entities.ISO_3166.TD import TdHolidays
...
class TestChad(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(TdHolidays)

    def test_no_holidays(self):
        self.assertNoHolidays(TdHolidays(years=1960))
    ...
    def test_freedom_and_democracy_day(self):
        ...
        self.assertNoHolidayName(name, TdHolidays(years=range(1961, 1991)))
