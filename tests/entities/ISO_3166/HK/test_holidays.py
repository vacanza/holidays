...
from holidays.calendars.gregorian import CHRISTMAS, WINTER_SOLSTICE
from holidays.constants import OPTIONAL
from holidays.entities.ISO_3166.HK import HkHolidays
from tests.common import CommonCountryTests


class TestHkHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(
            HkHolidays, years=range(1963, 2050), years_non_observed=range(1963, 2050)
        )
        cls.opt_holidays = HkHolidays(categories=(OPTIONAL,), years=range(1946, 2050))

    def test_no_holidays(self):
        self.assertNoHolidays(HkHolidays(years=1962))
        self.assertNoHolidays(HkHolidays(categories=(OPTIONAL,), years=1945))
    ...
    def test_winter_solstice(self):
        ...
        holidays_with_winter_solstice = HkHolidays(
        ...
        self.assertNoNonObservedHoliday(
            HkHolidays(observed=False, preferred_discretionary_holidays=(WINTER_SOLSTICE,)), obs_dt
        )
    ...
    def test_2020(self):
        ...
        self.assertHolidays(
            HkHolidays(years=2020, preferred_discretionary_holidays=(CHRISTMAS, WINTER_SOLSTICE)),
    ...
    def test_2021(self):
        ...
        self.assertHolidays(
            HkHolidays(years=2021, preferred_discretionary_holidays=(CHRISTMAS, WINTER_SOLSTICE)),
    ...
    def test_2022(self):
        ...
        self.assertHolidays(
            HkHolidays(years=2022, preferred_discretionary_holidays=(CHRISTMAS, WINTER_SOLSTICE)),
    ...
    def test_2023(self):
        ...
        self.assertHolidays(
            HkHolidays(years=2023, preferred_discretionary_holidays=(CHRISTMAS, WINTER_SOLSTICE)),
    ...
    def test_2024(self):
        ...
        self.assertHolidays(
            HkHolidays(years=2024, preferred_discretionary_holidays=(CHRISTMAS, WINTER_SOLSTICE)),
    ...
    def test_optional_2020(self):
        ...
        self.assertHolidays(
            HkHolidays(categories=OPTIONAL, years=2020),
            ("2020-01-01", "The first day of January"),
            ("2020-01-25", "Lunar New Year's Day"),
            ("2020-01-27", "The third day of Lunar New Year"),
            ("2020-01-28", "The fourth day of Lunar New Year"),
    ...
    def test_optional_2021(self):
        ...
        self.assertHolidays(
            HkHolidays(categories=OPTIONAL, years=2021),
            ("2021-01-01", "The first day of January"),
            ("2021-02-12", "Lunar New Year's Day"),
            ("2021-02-13", "The second day of Lunar New Year"),
            ("2021-02-15", "The fourth day of Lunar New Year"),
    ...
    def test_optional_2022(self):
        ...
        self.assertHolidays(
            HkHolidays(categories=OPTIONAL, years=2022),
            ("2022-01-01", "The first day of January"),
            ("2022-02-01", "Lunar New Year's Day"),
            ("2022-02-02", "The second day of Lunar New Year"),
            ("2022-02-03", "The third day of Lunar New Year"),
    ...
    def test_optional_2023(self):
        ...
        self.assertHolidays(
            HkHolidays(categories=OPTIONAL, years=2023),
    ...
    def test_optional_2024(self):
        ...
        self.assertHolidays(
            HkHolidays(categories=OPTIONAL, years=2024),
            ("2024-01-01", "The first day of January"),
            ("2024-02-10", "Lunar New Year's Day"),
            ("2024-02-12", "The third day of Lunar New Year"),
            ("2024-02-13", "The fourth day of Lunar New Year"),
