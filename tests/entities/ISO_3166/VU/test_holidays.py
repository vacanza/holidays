...
from holidays.entities.ISO_3166.VU import VuHolidays
from tests.common import CommonCountryTests


class TestVuHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(
            VuHolidays, years=range(1981, 2050), years_non_observed=range(2000, 2024)
        )

    def test_no_holidays(self):
        self.assertNoHolidays(VuHolidays(years=1980))
