...
from holidays.entities.ISO_3166.GA import GaHolidays
from tests.common import CommonCountryTests


class TestGaHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(GaHolidays)

    def test_no_holidays(self):
        self.assertNoHolidays(GaHolidays(years=1960))
    ...
    def test_womens_rights_day(self):
        ...
        self.assertNoHolidayName(name, GaHolidays(years=range(1961, 2015)))
