...
from holidays.entities.ISO_3166.PR import PrHolidays
from tests.common import CommonCountryTests


class TestPrHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(PrHolidays)
    ...
    def test_unofficial_holidays(self):
        self.assertHolidays(
            PrHolidays(categories=UNOFFICIAL, years=2024),
