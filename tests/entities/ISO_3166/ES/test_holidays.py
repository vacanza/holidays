...
class TestEsHolidays(CommonCountryTests, TestCase):
    ...
    def _assertVariableDays(self, year: int, subdiv_holidays: dict):  # noqa: N802
        observed_prov_holidays = {
            subdiv: EsHolidays(subdiv=subdiv, years=year) for subdiv in EsHolidays.subdivisions
        }
    ...
    def test_islamic(self):
        self.assertNoHolidayName(
            "Fiesta del Sacrificio-Eidul Adha", EsHolidays(subdiv="CE", years=2009)
        )
        self.assertNoHolidayName(
            "Fiesta del Sacrificio-Aid Al Adha", EsHolidays(subdiv="ML", years=2009)
        )
