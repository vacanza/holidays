...
class TestCrHolidays(CommonCountryTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(CrHolidays, years=range(1980, 2050))
    ...
    def test_feast_our_lady_of_angels(self):
        ...
        self.assertHolidayName(
            name,
            CrHolidays(categories=OPTIONAL, years=range(1980, 2050)),
    ...
    def test_black_person_day(self):
        ...
        opt_holidays = CrHolidays(categories=OPTIONAL, years=range(1980, 2050))
        opt_holidays_non_obs = CrHolidays(
    ...
    def test_2022(self):
        ...
        self.assertNonObservedHolidays(
            CrHolidays(years=2022, observed=False),
            ("2022-01-01", "Año Nuevo"),
            ("2022-04-11", "Día de Juan Santamaría"),
            ("2022-04-14", "Jueves Santo"),
            ("2022-04-15", "Viernes Santo"),
    ...
    def test_optional_2022(self):
        self.assertHolidays(
            CrHolidays(categories=OPTIONAL, years=2022),
    ...
    def test_optional_2023(self):
        self.assertHolidays(
            CrHolidays(categories=OPTIONAL, years=2023),
