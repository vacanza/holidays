...
class TestUSNewYork(CommonFinancialTests, TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass(USNewYork)

    def test_market_aliases(self):
        self.assertAliases(USNewYork, USNY, USNewYorkFinancial)

    def test_no_holidays(self):
        self.assertNoHolidays(USNewYork(years=1949))
    ...
    def test_martin_luther_king_jr_day(self):
        # Not observed before 1998 in financial markets.
