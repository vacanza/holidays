...
class TestTaiwanStockExchange(CommonFinancialTests, TestCase):
    ...
    def test_labor_day(self):
        name = "勞動節"
        self.assertHolidayName(name, (f"{year}-05-01" for year in range(2008, 2026)))
        obs_dts = (
            "2010-04-30",
            "2011-05-02",
            "2016-05-02",
        ...
        self.assertHolidayName(f"{name}（調整放假）", obs_dts)
    ...
    def test_2025(self):
        self.assertHolidaysInYear(
            ...
            ("2025-05-31", "端午節"),
            ("2025-09-28", "孔子誕辰紀念日"),
            ("2025-09-29", "孔子誕辰紀念日（調整放假）"),
            ("2025-10-06", "中秋節"),
            ("2025-10-10", "國慶日"),
            ("2025-10-24", "臺灣光復暨金門古寧頭大捷紀念日（調整放假）"),
    ...
    def test_l10n_en_us(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-02-13", "Chinese New Year (Adjusted Holiday)"),
            ("2024-02-14", "Chinese New Year (Adjusted Holiday)"),
            ("2024-02-28", "Peace Memorial Day"),
            ("2024-04-04", "Children's Day; Tomb-Sweeping Day"),
            ("2024-04-05", "Children's Day (Adjusted Holiday)"),
    ...
    def test_l10n_th(self):
        self.assertLocalizedHolidays(
            ...
            ("2024-02-06", "ไม่มีการซื้อขาย (เปิดทำการชำระราคาและส่งมอบหลักทรัพย์เท่านั้น)"),
            ("2024-02-07", "ไม่มีการซื้อขาย (เปิดทำการชำระราคาและส่งมอบหลักทรัพย์เท่านั้น)"),
            ...
            ("2024-04-05", "ชดเชยวันเด็กแห่งชาติ"),
