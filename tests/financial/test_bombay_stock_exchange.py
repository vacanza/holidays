...
class TestBombayStockExchange(CommonFinancialTests, TestCase):
    ...
    def test_l10n_mr(self):
        self.assertLocalizedHolidays(
            "mr",
            ("2023-01-26", "प्रजासत्ताक दिन"),
            ("2023-03-07", "होळी"),
            ("2023-03-30", "रामनवमी"),
            ("2023-04-04", "महावीर जन्म कल्याणक"),
            ("2023-04-07", "गुड फ्रायडे"),
            ("2023-04-14", "डॉ. बाबासाहेब आंबेडकर जयंती"),
            ("2023-05-01", "महाराष्ट्र दिन"),
            ("2023-06-28", "बकरी ईद"),
            ("2023-08-15", "स्वातंत्र्य दिन"),
            ("2023-09-19", "गणेश चतुर्थी"),
            ("2023-10-02", "महात्मा गांधी जयंती"),
            ("2023-10-24", "दसरा"),
