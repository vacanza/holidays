...
class TestNewYorkStockExchange(CommonFinancialTests, TestCase):
    ...
    def test_l10n_mr(self):
        self.assertLocalizedHolidays(
            "mr",
            ("2024-01-01", "नवीन वर्षाचा दिवस"),
            ("2024-01-15", "मार्टिन ल्यूथर किंग ज्युनियर दिन"),
            ("2024-02-19", "वॉशिंग्टनचा वाढदिवस"),
            ("2024-03-29", "गुड फ्रायडे"),
            ("2024-05-27", "स्मृती दिन"),
            ("2024-06-19", "जुनटीन्थ राष्ट्रीय स्वातंत्र्य दिन"),
            ("2024-07-03", "स्वातंत्र्य दिनाच्या आधीचा दिवस (बाजार दुपारी 1:00 वाजता बंद होतात)"),
            ("2024-07-04", "स्वातंत्र्य दिन"),
            ("2024-09-02", "कामगार दिन"),
            ("2024-11-28", "थँक्सगिव्हिंग दिन"),
            ("2024-11-29", "थँक्सगिव्हिंग दिनानंतरचा दिवस (बाजार दुपारी 1:00 वाजता बंद होतात)"),
            ("2024-12-24", "नाताळ पूर्वसंध्या (बाजार दुपारी 1:00 वाजता बंद होतात)"),
            ("2024-12-25", "नाताळ"),
    )
