...
class _IslamicMabimsLunar(_CustomCalendar, _IslamicLunar):
    ...
    Dates are calculated using Singapore as the reference location
    (primary MABIMS Hisab observer) with the MABIMS 2021 criteria:
    - Moon altitude >= 3 degrees at sunset
