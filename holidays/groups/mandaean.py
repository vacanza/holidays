...
class MandaeanHolidays:
    ...
    def _get_parwanaya_date(self):
        return self._mandaean.mandaean_to_gregorian(self._year, 13, 1)

    def _get_dehwa_hanina_date(self):
        return self._mandaean.mandaean_to_gregorian(self._year, 9, 23)
    ...
    def _add_dehwa_daimana_day(self, name) -> Optional[date]:
        ...
        return self._add_mandaean_holiday(
            name, self._mandaean.mandaean_to_gregorian(self._year, 11, 1)
        )
