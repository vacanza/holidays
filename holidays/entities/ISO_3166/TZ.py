...
class TzHolidays(
    ...
    """A class to represent holidays for Tanzania."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=TzIslamicHolidays)
        StaticHolidays.__init__(self, TzStaticHolidays)
...
class TzIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2013: (OCT, 15),
        2014: (OCT, 5),
        2015: (SEP, 23),
