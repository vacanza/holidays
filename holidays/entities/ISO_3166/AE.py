...
class AeHolidays(HolidayBase, Iso3166Entity, InternationalHolidays, IslamicHolidays):
    """A class to represent holidays for United Arab Emirates."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=AeIslamicHolidays)
...
class AeIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2017: (SEP, 1),
        2018: (AUG, 21),
        2019: (AUG, 11),
