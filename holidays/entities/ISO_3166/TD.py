...
class TdHolidays(
    ...
    """A class to represent holidays for Chad."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=TdIslamicHolidays)
        StaticHolidays.__init__(self, TdStaticHolidays)
...
class TdIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2015: (SEP, 24),
        2016: (SEP, 13),
        2017: (SEP, 2),
