...
class IdHolidays(
    ...
    def __init__(self, *args, **kwargs):
        BuddhistCalendarHolidays.__init__(self, cls=IdBuddhistHolidays, show_estimated=True)
        ChineseCalendarHolidays.__init__(self, cls=IdChineseHolidays, show_estimated=True)
        ChristianHolidays.__init__(self)
        InternationalHolidays.__init__(self)
        IslamicHolidays.__init__(self, cls=IdIslamicHolidays)
        StaticHolidays.__init__(self, cls=IdStaticHolidays)
...
class IdBuddhistHolidays(_CustomBuddhistHolidays):
    VESAK_DATES = {
        2007: (JUN, 1),
        2008: (MAY, 20),
        2009: (MAY, 9),
...
class IdChineseHolidays(_CustomChineseHolidays):
...
class IdIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2001: (MAR, 6),
        2002: (FEB, 23),
        2003: (FEB, 12),
