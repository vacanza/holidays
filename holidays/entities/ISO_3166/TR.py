...
class TrHolidays(HolidayBase, InternationalHolidays, IslamicHolidays, StaticHolidays):
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, TrIslamicHolidays)
        StaticHolidays.__init__(self, TrStaticHolidays)
...
class TrIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        1936: (MAR, 4),
        1937: (FEB, 22),
        1938: (FEB, 11),
