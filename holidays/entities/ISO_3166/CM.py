...
class CmHolidays(
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=CmIslamicHolidays)
        StaticHolidays.__init__(self, cls=CmStaticHolidays)
...
class CmIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2001: (MAR, 6),
        2002: (FEB, 23),
        2003: (FEB, 12),
