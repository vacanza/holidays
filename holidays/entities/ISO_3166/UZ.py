...
class UzHolidays(ObservedHolidayBase, InternationalHolidays, IslamicHolidays, StaticHolidays):
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, UzIslamicHolidays)
        StaticHolidays.__init__(self, UzStaticHolidays)
...
class UzIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2006: ((JAN, 10), (DEC, 30)),
        2007: (DEC, 19),
        2008: (DEC, 8),
