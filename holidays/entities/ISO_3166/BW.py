...
class BwHolidays(ObservedHolidayBase, ChristianHolidays, InternationalHolidays, StaticHolidays):
    """A class to represent holidays for Botswana."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        StaticHolidays.__init__(self, BwStaticHolidays)
