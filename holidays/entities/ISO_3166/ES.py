...
class EsHolidays(
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=EsIslamicHolidays)
        StaticHolidays.__init__(self, cls=EsStaticHolidays)
...
class EsIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2010: (NOV, 17),
        2011: (NOV, 6),
        2012: (OCT, 25),
