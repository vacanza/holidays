...
class BnHolidays(
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=BnIslamicHolidays)
        StaticHolidays.__init__(self, cls=BnStaticHolidays)
    ...
    def _populate_public_holidays(self):
        ...
        # 3: If Fri-Sat-Sun -> Mon (1st Day +3)
...
class BnIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2000: (MAR, 16),
        2001: (MAR, 6),
        2002: (FEB, 23),
