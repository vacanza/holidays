...
class AzHolidays(ObservedHolidayBase, InternationalHolidays, IslamicHolidays, StaticHolidays):
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, AzIslamicHolidays)
        StaticHolidays.__init__(self, AzStaticHolidays)
...
class AzIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2002: (FEB, 21),
        2003: (FEB, 11),
        2004: (FEB, 1),
