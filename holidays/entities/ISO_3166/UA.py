...
class UaHolidays(ObservedHolidayBase, ChristianHolidays, InternationalHolidays, StaticHolidays):
    """A class to represent holidays for Ukraine."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        StaticHolidays.__init__(self, UaStaticHolidays)
