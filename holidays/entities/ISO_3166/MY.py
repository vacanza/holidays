...
class MyHolidays(
    ...
    def __init__(self, *args, **kwargs):
        BuddhistCalendarHolidays.__init__(self, cls=MyBuddhistHolidays, show_estimated=True)
        ChineseCalendarHolidays.__init__(self, cls=MyChineseHolidays, show_estimated=True)
        ChristianHolidays.__init__(self)
        HinduCalendarHolidays.__init__(self, cls=MyHinduHolidays)
        InternationalHolidays.__init__(self)
        IslamicHolidays.__init__(self, cls=MyIslamicHolidays)
        StaticHolidays.__init__(self, cls=MyStaticHolidays)
...
class MyBuddhistHolidays(_CustomBuddhistHolidays):
    VESAK_MAY_DATES = {
        2001: (MAY, 7),
        2002: (MAY, 27),
        2003: (MAY, 15),
...
class MyChineseHolidays(_CustomChineseHolidays):
...
class MyHinduHolidays(_CustomHinduHolidays):
    DIWALI_DATES = {
        2001: (NOV, 14),
        2002: (NOV, 3),
        2003: (OCT, 23),
...
class MyIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2001: (MAR, 6),
        2002: (FEB, 23),
        2003: (FEB, 12),
