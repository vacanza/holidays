...
class TlHolidays(
    ...
    def __init__(self, *args, **kwargs):
        ...
        IslamicHolidays.__init__(self, cls=TlIslamicHolidays)
        StaticHolidays.__init__(self, TlStaticHolidays)
...
class TlIslamicHolidays(_CustomIslamicHolidays):
    EID_AL_ADHA_DATES = {
        2011: (NOV, 7),
        2012: (OCT, 26),
        2013: (OCT, 15),
