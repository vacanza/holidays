...
class KrHolidays(
    ...
    def __init__(self, *args, **kwargs):
        ChineseCalendarHolidays.__init__(self, cls=KrLunisolarHolidays)
        ChristianHolidays.__init__(self)
        InternationalHolidays.__init__(self)
        StaticHolidays.__init__(self, cls=KrStaticHolidays)
...
class KrLunisolarHolidays(_CustomChineseHolidays):
