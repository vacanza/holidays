...
class ICEFuturesEurope(ObservedHolidayBase, ChristianHolidays, InternationalHolidays):
    ...
    References:
        ...
        * <https://web.archive.org/web/20230927015846/https://web.archive.org/web/20241118133442/https://www.ice.com/publicdocs/Trading_Schedule.pdf>
        * <https://web.archive.org/web/20211022183728/https://web.archive.org/web/20241118133442/https://www.ice.com/publicdocs/Trading_Schedule.pdf>
    """
