...
class NewYorkStockExchangeStaticHolidays:
    special_public_holidays = {
        ...
        1889: (
            (APR, 29, "Centennial of George Washington's Inauguration"),
            (APR, 30, "Centennial of George Washington's Inauguration"),
            (MAY, 1, "Centennial of George Washington's Inauguration"),
        ),
        1892: (
