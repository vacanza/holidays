...
class Montserrat(ObservedHolidayBase, ChristianHolidays, InternationalHolidays, StaticHolidays):
    ...
    References:
        ...
        * [Montserrat Public holidays, 2025](https://www.gov.ms/wp-content/uploads/2023/12/Public-Holidays-Montserrat-2024.docx.pdf)
    """
    ...
    def _populate_public_holidays(self):
        ...
        if self._year >= 2021:
            ...
            name = tr("National Day of Prayer and Thanksgiving")
