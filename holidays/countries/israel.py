...
from holidays.calendars import _ExtrasRequireHebrew
from holidays.holiday_base import HolidayBase

# _ExtrasRequireHebrew related attributes.
gregorian = hebrew = hanukkah = lag_baomer = passover = None
purim = rosh_hashanah = shavuot = sukkot = yom_kippur = None


class Israel(HolidayBase, _ExtrasRequireHebrew):
    country = "IL"

    def __init__(self, **kwargs):
        _ExtrasRequireHebrew.__init__(self, globals())
