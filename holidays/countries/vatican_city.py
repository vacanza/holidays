...
class VaticanCity(HolidayBase, ChristianHolidays, InternationalHolidays):
    ...
    Art. 27 (Festività e vacanze)

    Oltre alle domeniche, e alle altre feste di precetto secondo il canone 1246 del
    Codice di Diritto Canonico, saranno giorni di vacanza anche:
        ...
        8)  la Commemorazione di tutti i fedeli defunti;
        9)  la vigilia e i due giorni successivi al Santo Natale;
        10) l'ultimo giorno dell'anno.

    1917 Code of Canon Law - Canon 1247
        § 1. Feast days under precept in the whole Church are only: All and every [Sunday],
        the feast of the Nativity, Circumcision, Epiphany, Ascension,
        and the most holy Body of Christ, Immaculate Conception, and Assumption of Mary
        the Mother of God, of Saint Joseph her spouse, of the Blessed Apostles Peter and Paul,
        and of All the Saints.

        § 2. The feast days of Patrons do not bind by ecclesiastical precept; local Ordinaries
        can transfer the external solemnity to the next following [Sunday].
    ...
    1983 Code of Canon Law - Canon 1946
        §1. Sunday, on which by apostolic tradition the paschal mystery is celebrated,
        must be observed in the universal Church as the primordial holy day of obligation.
        The following days must also be observed: the Nativity of our Lord Jesus Christ,
        the Epiphany, the Ascension, the Body and Blood of Christ, Holy Mary the Mother of God,
        her Immaculate Conception, her Assumption, Saint Joseph, Saint Peter and Saint Paul
        the Apostles, and All Saints.

        §2. With the prior approval of the Apostolic See, however, the conference of bishops can
        suppress some of the holy days of obligation or transfer them to a Sunday.
    """
