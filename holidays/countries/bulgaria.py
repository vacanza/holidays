...
from holidays.calendars.gregorian import MAR, MAY, SEP, NOV
...
class Bulgaria(HolidayBase, ChristianHolidays, InternationalHolidays):
    ...
    def _populate_public_holidays(self):
        ...
        # Christmas Eve.
        observed_dates.add(self._add_christmas_eve(tr("Бъдни вечер")))

        # Christmas Day.
        name = tr("Рождество Христово")
        observed_dates.add(self._add_christmas_day(name))
        observed_dates.add(self._add_christmas_day_two(name))
