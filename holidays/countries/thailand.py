...
class Thailand(ObservedHolidayBase, InternationalHolidays, StaticHolidays, ThaiCalendarHolidays):
    ...
    * Checked with: [Bank of Thailand lists](http://tiny.cc/wa_bot_2023)
    ...
    * [New Year's Day]
        ...
        - [wikisource.org](http://tiny.cc/wa_wiki_thai_newyear_2483)
    ...
    * [Chakri Memorial Day]
        ...
        - [ocac.got.th](http://tiny.cc/wa_ocac_chakri)
    ...
    * Royal Ploughing Ceremony Day is date is announced on an annual basis
    ...
    Country created by: [arkid15r](https://github.com/arkid15r)
