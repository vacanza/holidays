...
class Thailand(HolidayBase):
    ...
    rama_nine_sixty_accession_en = "HM King Bhumibol Adulyadej's 60th Anniversary of Accession Event"
    thai_military_emergency_lockdown_en = "Emergency Lockdown (Thai Military Coup d'état)"
    thai_political_emergency_lockdown_en = "Emergency Lockdown (Thai Political Unrest)"
    thai_flood_2011_emergency_lockdown_en = "Emergency Lockdown (2011 Thailand Floods)"
    rama_nine_mourning_en = "Day of Mourning for HM King Bhumibol Adulyadej"
    rama_nine_cremation_en = "HM King Bhumibol Adulyadej's Royal Cremation Ceremony"
    rama_ten_coronation_celebrations_en = "HM King Maha Vajiralongkorn's Coronation Celebrations"
    songkran_festival_in_lieu_covid_en = "Songkran Festival (in lieu)"

    special_holidays = {
        ### 1992-1994 (include In Lieus, Checked /w Bank of Thailand Data) ###
        1992: ((MAY, 18, thai_special_in_lieu_holidays_en),),
        1992: ((DEC, 7, thai_special_in_lieu_holidays_en),),
        1993: ((MAR, 8, thai_special_in_lieu_holidays_en),),
        1993: ((MAY, 3, thai_special_in_lieu_holidays_en),),
        1993: ((OCT, 25, thai_special_in_lieu_holidays_en),),
        1993: ((DEC, 6, thai_special_in_lieu_holidays_en),),
        1994: ((JAN, 3, thai_special_in_lieu_holidays_en),),
        1994: ((MAY, 2, thai_special_in_lieu_holidays_en),),
        1994: ((JUL, 25, thai_special_in_lieu_holidays_en),),
        1994: ((OCT, 24, thai_special_in_lieu_holidays_en),),
        1994: ((DEC, 12, thai_special_in_lieu_holidays_en),),
        ...
        1998: ((MAY, 11, thai_special_in_lieu_holidays_en),),
        1998: ((DEC, 7, thai_special_in_lieu_holidays_en),),
        1999: ((MAY, 3, thai_special_in_lieu_holidays_en),),
        1999: ((MAY, 31, thai_special_in_lieu_holidays_en),),
        1999: ((OCT, 25, thai_special_in_lieu_holidays_en),),
        1999: ((DEC, 6, thai_special_in_lieu_holidays_en),),
        2000: ((JAN, 3, thai_special_in_lieu_holidays_en),),
        2000: ((FEB, 21, thai_special_in_lieu_holidays_en),),
        2000: ((AUG, 14, thai_special_in_lieu_holidays_en),),
        2000: ((DEC, 11, thai_special_in_lieu_holidays_en),),
        ### From 2001 Onwards (Checked /w Bank of Thailand Data) ###
        2006: ((APR, 19, thai_election_en),),
        2006: ((JUN, 9, rama_nine_sixty_accession_en),),
        2006: ((JUN, 12, rama_nine_sixty_accession_en),),
        2006: ((JUN, 13, rama_nine_sixty_accession_en),),
        2006: ((SEP, 20, thai_military_emergency_lockdown_en),),
        2007: ((DEC, 24, thai_election_in_lieu_en),),
        2009: ((JAN, 2, thai_bridge_public_holiday_en),),
        2009: ((APR, 10, thai_political_emergency_lockdown_en),),
        2009: ((APR, 16, thai_political_emergency_lockdown_en),),
        2009: ((APR, 17, thai_political_emergency_lockdown_en),),
        2009: ((JUL, 6, thai_bridge_public_holiday_en),),
        2010: ((MAY, 20, thai_bridge_public_holiday_en),),
        2010: ((MAY, 21, thai_bridge_public_holiday_en),),
        2010: ((AUG, 13, thai_bridge_public_holiday_en),),
        2011: ((MAY, 16, thai_bridge_public_holiday_en),),
        2011: ((OCT, 27, thai_flood_2011_emergency_lockdown_en),),
        2011: ((OCT, 28, thai_flood_2011_emergency_lockdown_en),),
        2011: ((OCT, 31, thai_flood_2011_emergency_lockdown_en),),
        2012: ((JAN, 3, thai_bridge_public_holiday_en),),
        ...
        2015: ((JAN, 2, thai_bridge_public_holiday_en),),
        2015: ((MAY, 4, thai_bridge_public_holiday_en),),
        2016: ((MAY, 6, thai_bridge_public_holiday_en),),
        2016: ((JUL, 18, thai_bridge_public_holiday_en),),
        2016: ((OCT, 14, rama_nine_mourning_en),),
        2017: ((OCT, 26, rama_nine_cremation_en),),
        2019: ((MAY, 6, rama_ten_coronation_celebrations_en),),
        2020: ((JUL, 27, songkran_festival_in_lieu_covid_en),),
        2020: ((SEP, 4, songkran_festival_in_lieu_covid_en),),
        2020: ((SEP, 7, songkran_festival_in_lieu_covid_en),),
        2020: ((NOV, 19, thai_bridge_public_holiday_en),),
        2020: ((NOV, 20, thai_bridge_public_holiday_en),),
        2020: ((DEC, 11, thai_bridge_public_holiday_en),),
        2021: ((FEB, 12, thai_bridge_public_holiday_en),),
        2021: ((APR, 12, thai_bridge_public_holiday_en),),
        2021: ((SEP, 24, thai_bridge_public_holiday_en),),
        2022: ((JUL, 15, thai_bridge_public_holiday_en),),
        2022: ((JUL, 29, thai_bridge_public_holiday_en),),
        2022: ((OCT, 14, thai_bridge_public_holiday_en),),
        2022: ((DEC, 30, thai_bridge_public_holiday_en),),
    ...
    def _populate(self, year):
        ...
        # Now acts as the Queen Mother
            ...
            add_holiday(date(year, AUG, 12), queen_sirikit_birthday_rama_ten_en)
        ...
        athikawan_years_gregorian = {
            1945, 1949, 1952, 1957, 1963, 1970, 1973, 1979, 1987, 1990, 1997, 2000, 2006, 2009, 2016,
            2020, 2025, 2032, 2035, 2043, 2046, 2052,
        }
        ...
        if year >= 1942 and year < 2058:
            while thai_lunar_calendar_begin_year < year:
                ...
                elif thai_lunar_calendar_begin_year in athikawan_years_gregorian:
            ...
            if year in athikamat_years_gregorian:
                add_holiday(thai_lunar_calendar_start_date+td(days=+102), makha_bucha_en)
            else:
                add_holiday(thai_lunar_calendar_start_date+td(days=+73), makha_bucha_en)
            ...
            if year in athikamat_years_gregorian:
                add_holiday(thai_lunar_calendar_start_date+td(days=+250), asarnha_bucha_en)
            elif year in athikawan_years_gregorian:
                add_holiday(thai_lunar_calendar_start_date+td(days=+221), asarnha_bucha_en)
            else:
                add_holiday(thai_lunar_calendar_start_date+td(days=+220), asarnha_bucha_en)
            ...
            if year in athikamat_years_gregorian:
                add_holiday(thai_lunar_calendar_start_date+td(days=+251), khao_phansa_en)
            elif year in athikawan_years_gregorian:
                add_holiday(thai_lunar_calendar_start_date+td(days=+222), khao_phansa_en)
            else:
                add_holiday(thai_lunar_calendar_start_date+td(days=+221), khao_phansa_en)
