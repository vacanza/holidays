...
class Ecuador(ObservedHolidayBase, ChristianHolidays, InternationalHolidays):
    ...
    References:
        ...
        * [Código del Trabajo](https://web.archive.org/web/20241120135529/http://biblioteca.defensoria.gob.ec/bitstream/37000/3364/1/C%C3%B3digo%20de%20Trabajo%20(04-11-2021).pdf)
    """
