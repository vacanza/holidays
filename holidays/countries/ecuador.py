...
class Ecuador(ObservedHolidayBase, ChristianHolidays, InternationalHolidays):
    ...
    References:
        ...
        * [Código del Trabajo](https://web.archive.org/web/20250428092005/https://biblioteca.defensoria.gob.ec/bitstream/37000/3364/1/Código%20de%20Trabajo%20%2804-11-2021%29.pdf)
    """
