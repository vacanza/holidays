...
class Nepal(
    ...
    def _populate_public_holidays(self):
        ...
        # Fagu Poornima.
        self._add_nepal_holi(tr("फागु पूर्णिमा"))

        # Fagu Poornima (Terai).
        self._add_holi(tr("फागु पूर्णिमा (तराई)"))
        ...
        # Laxmi Pooja.
        self._add_diwali_india(tr("लक्ष्मी पूजा"))
        ...
        # Eid al-Fitr.
        self._add_eid_al_fitr_day(tr("इद उल अजहा"))
