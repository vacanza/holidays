...
class _ThaiLuniSolar:
    def __init__(self) -> None:
        ...
        ** Thai Lunar Calendar Holidays only work from 1941 (B.E. 2484) onwards
        ...
        self.ATHIKAWAN_YEARS_GREGORIAN = {
            1945,
            1949,
            1952,
            1957,
        ...
        self.ATHIKAMAT_YEARS_GREGORIAN = {
            1942,
            1944,
            1947,
            1950,
        ...
        self.THAI_LUNAR_CALENDAR_START_DATE = date(1940, 11, 30)
        self.THAI_LUNAR_CALENDAR_START_YEAR = 1941
    ...
    def _get_start_date(self, year: int) -> Optional[date]:
        ...
        while iter_start_year < year:
            if iter_start_year in self.ATHIKAMAT_YEARS_GREGORIAN:
                delta_days = 384
            elif iter_start_year in self.ATHIKAWAN_YEARS_GREGORIAN:
                delta_days = 355
            else:
                delta_days = 354
