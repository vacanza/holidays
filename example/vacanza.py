...
def get_years(year_input: str) -> List[int]:
    ...
    try:
        ...
        print(f"Error: Invalid year format '{year_input}'. Use YYYY or YYYY-YYYY.")
        sys.exit(1)
...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("  python examples/vacanza.py MZ 2026")
        print("  python examples/vacanza.py US 2020-2025 public-holidays\n")
        sys.exit(1)
