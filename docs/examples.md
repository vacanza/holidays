...
```bash
python examples/vacanza.py [COUNTRY_CODE] [YEAR_OR_RANGE] [OPTIONS]
```
...
```bash
python examples/vacanza.py SE 2025-2030
```

**4. Filter by a specific category**
If you only want public holidays for a country:
```bash
python examples/vacanza.py GB 2025 --category public
```
...
```bash
python examples/vacanza.py NG 2025-2026 -o ./my_calendars/
```

**6. List all supported countries**
If you don't know the code for a country, list them all to find it:
```bash
python examples/vacanza.py --list-countries
```
