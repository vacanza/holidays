...
class TestBO(unittest.TestCase):
    ...
    def test_la_tablada(self):
        ...
        for d in (date(2015, 4, 15), 2016, 4, 15):
    ...
    def test_carnival_monday(self):
        ...
        for d in (date(2020, 2, 24), date(2023, 2, 21)):
            self.assertIn(d, self.holidays)
    ...
    def test_chuquisaca_day(self):
        ...
        for d in (date(2020, 5, 25), 2021, 5, 25):
    ...
    def test_andean_new_year(self):
        ...
        for d in (date(2010, 6, 21), date(2011, 6, 21), date(2020, 6, 22)):
            self.assertIn(d, self.holidays_observed)
    ...
    def test_independence_day(self):
        ...
        for d in (date(1825, 8, 6), date(2020, 8, 6), date(2023, 8, 7)):
            self.assertIn(d, self.holidays_observed)
    ...
    def test_all_souls_day(self):
        ...
        for d in (date(2020, 11, 2), date(2021, 11, 2), date(2025, 11, 3)):
            self.assertIn(d, self.holidays_observed)
    ...
    def test_christmas_day(self):
        ...
        for d in (date(2017, 12, 25), date(2022, 12, 26)):
            self.assertIn(d, self.holidays_observed)
