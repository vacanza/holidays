...
class TestMalaysia(unittest.TestCase):
    ...
    def test_KDH_holidays(self):
        Kedah_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="KDH")
    ...
    def test_KTN_holidays(self):
        Kelantan_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="KTN")
    ...
    def test_MLK_holidays(self):
        Malacca_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="MLK")
    ...
    def test_NSN_holidays(self):
        Negeri_Sembilan_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="NSN")
    ...
    def test_PNG_holidays(self):
        Penang_holidays = holidays.MY(years=[2023,2024,2019,2020,2021,2022],state="PNG")
    ...
    def test_PRK_holidays(self):
        Perak_holidays = holidays.MY(years=[2013,2018,2019,2020,2021,2022],state="PRK")
    ...
    def test_SBH_holidays(self):
        Sabah_holidays = holidays.MY(years=[2017,2018,2019,2020,2021,2022],state="SBH")
    ...
    def test_SWK_holidays(self):
        Sarawakholidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="SWK")
        # Gawai Dayak
    ...
    def test_SGR_holidays(self):
        Selangor_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="SGR")
    ...
    def test_TRG_holidays(self):
        Terengganu_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="TRG")
    ...
    def test_KUL_holidays(self):
        Kuala_Lumpur_holidays = holidays.MY(years=[1970,2018,2019,2020,2021,2022],state="KUL")
    ...
    def test_LBN_holidays(self):
        Labuan_holidays = holidays.MY(years=[1972,2018,2019,2020,2021,2022],state="LBN")
        # Pesta Kaamatan
    ...
    def test_PJY_holidays(self):
        Putrajaya_holidays = holidays.MY(years=[2018,2019,2020,2021,2022],state="PJY")
        # Federal Territory Day
