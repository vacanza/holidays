...
class HongKong(HolidayBase):
    ...
    # Calculate the Gregorian date according to the lunar calendar, return 
    # an array [datetime1, datetime2], if it is Haoyue, it may contain two 
    # dates, otherwise there is only one
