...
class Italy(HolidayBase):
    ...
    def _populate(self, year):
        ...
        if self.prov:
            ...
            elif self.prov == 'Padova':
                self[date(year, 6, 13)] = "Sant'Antonio di Padova"
            elif self.prov in ('PA', 'Palermo'):
                self[date(year, 7, 15)] = "San Giovanni"
            elif self.prov == 'Parma':
                self[date(year, 1, 13)] = "Sant'Illario di Poitiers"
            elif self.prov == 'Perugia':
                self[date(year, 1, 29)] = "Sant'Ercolano e san Lorenzo"
            elif self.prov == 'Piacenza':
                self[date(year, 7, 4)] = "Sant'Antonino di Piacenza"
            elif self.prov == 'RM':
